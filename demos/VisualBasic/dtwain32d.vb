...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_GetTwainStringNameA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainStringNameW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Auto Function DTWAIN_GetTwainStringName Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPTStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainStringNameA Lib "dtwain32d.dll" (sz As System.IntPtr, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainStringNameW Lib "dtwain32d.dll" (sz As System.IntPtr, nLength As Integer) As Integer
    Declare Auto Function DTWAIN_GetTwainStringName Lib "dtwain32d.dll" (sz As System.IntPtr, nLength As Integer) As Integer
End Class
