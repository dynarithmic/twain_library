...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_SetPDFEncryptionA Lib "dtwain64ud.dll" (Source As System.IntPtr, bUseEncryption As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszUser As String, <MarshalAs(UnmanagedType.LPStr)> lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_SetTwainLogA Lib "dtwain64ud.dll" (LogFlags As UInteger, <MarshalAs(UnmanagedType.LPStr)> lpszLogFile As String) As Integer
    ...
    Declare Unicode Function DTWAIN_SetPDFEncryptionW Lib "dtwain64ud.dll" (Source As System.IntPtr, bUseEncryption As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszUser As String, <MarshalAs(UnmanagedType.LPWStr)> lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    ...
    Declare Unicode Function DTWAIN_SetTwainLogW Lib "dtwain64ud.dll" (LogFlags As UInteger, <MarshalAs(UnmanagedType.LPWStr)> lpszLogFile As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetPDFEncryption Lib "dtwain64ud.dll" (Source As System.IntPtr, bUseEncryption As Integer, <MarshalAs(UnmanagedType.LPTStr)> lpszUser As String, <MarshalAs(UnmanagedType.LPTStr)> lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetTwainLog Lib "dtwain64ud.dll" (LogFlags As UInteger, <MarshalAs(UnmanagedType.LPTStr)> lpszLogFile As String) As Integer
    ...
    Declare Ansi Function DTWAIN_ArraySetAtFrameStringA Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Left As String, <MarshalAs(UnmanagedType.LPStr)> Top As String, <MarshalAs(UnmanagedType.LPStr)> Right As String, <MarshalAs(UnmanagedType.LPStr)> Bottom As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtFrameStringW Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> Left As String, <MarshalAs(UnmanagedType.LPWStr)> Top As String, <MarshalAs(UnmanagedType.LPWStr)> Right As String, <MarshalAs(UnmanagedType.LPWStr)> Bottom As String) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFrameString Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Left As String, <MarshalAs(UnmanagedType.LPTStr)> Top As String, <MarshalAs(UnmanagedType.LPTStr)> Right As String, <MarshalAs(UnmanagedType.LPTStr)> Bottom As String) As Integer

    Declare Ansi Function DTWAIN_ArraySetAtFloatStringA Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Val As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtFloatStringW Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> Val As String) As Integer
    Declare Auto Function    DTWAIN_ArraySetAtFloatString Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As String) As Integer

    Declare Ansi Function    DTWAIN_ArrayGetAtFloatStringA Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As StringBuilder) As Integer
    Declare Unicode Function DTWAIN_ArrayGetAtFloatStringW Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As StringBuilder) As Integer
    Declare Auto Function    DTWAIN_ArrayGetAtFloatString Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As StringBuilder) As Integer

    Declare Ansi Function    DTWAIN_ArrayFindFloatStringA Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Val As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindFloatStringW Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> Val As String) As Integer
    Declare Auto Function    DTWAIN_ArrayFindFloatString Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As String) As Integer

    Declare Ansi Function    DTWAIN_ArrayFindFloatStringNA Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayFindFloatStringNW Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> Val As String, num As Integer) As Integer
    Declare Auto Function    DTWAIN_ArrayFindFloatStringN Lib "dtwain64ud.dll" (theArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPTStr)> Val As String, num As Integer) As Integer

    Declare Ansi Function    DTWAIN_ArrayFindFloatStringA Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Val As String, <MarshalAs(UnmanagedType.LPTStr)> Tolerance As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindFloatStringW Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPWStr)> Val As String, <MarshalAs(UnmanagedType.LPTStr)> Tolerance As String) As Integer
    Declare Auto Function    DTWAIN_ArrayFindFloatString Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPTStr)> Val As String, <MarshalAs(UnmanagedType.LPTStr)> Tolerance As String) As Integer

    Declare Ansi Function    DTWAIN_ArrayAddFloatStringA Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Val As String) As Integer
    Declare Unicode Function DTWAIN_ArrayAddFloatStringW Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPWStr)> Val As String) As Integer
    Declare Auto Function    DTWAIN_ArrayAddFloatString Lib "dtwain64ud.dll" (theArray As System.IntPtr, <MarshalAs(UnmanagedType.LPTStr)> Val As String) As Integer
