...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_GetTwainStringNameA Lib "dtwain64ud.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainStringNameW Lib "dtwain64ud.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Auto Function DTWAIN_GetTwainStringName Lib "dtwain64ud.dll" (<MarshalAs(UnmanagedType.LPTStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainStringNameA Lib "dtwain64ud.dll" (sz As System.IntPtr, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainStringNameW Lib "dtwain64ud.dll" (sz As System.IntPtr, nLength As Integer) As Integer
    Declare Auto Function DTWAIN_GetTwainStringName Lib "dtwain64ud.dll" (sz As System.IntPtr, nLength As Integer) As Integer
End Class
