...
Public Class BarCodesDlg
    ...
    Private Sub BarCodesDlg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim bOk As Integer = VB_FullDemo.DTWAINAPI.DTWAIN_InitExtImageInfo(m_Source)
        If bOk = 0 Then
        ...
        bOk = VB_FullDemo.DTWAINAPI.DTWAIN_GetExtImageInfoData(m_Source, DTWAINAPI.DTWAIN_EI_BARCODECOUNT, aCount)
        If bOk = 1 And VB_FullDemo.DTWAINAPI.DTWAIN_ArrayGetCount(aCount) > 0 Then
            Dim barCount As Integer = 0
            VB_FullDemo.DTWAINAPI.DTWAIN_ArrayGetAtLong(aCount, 0, barCount)
            VB_FullDemo.DTWAINAPI.DTWAIN_ArrayDestroy(aCount)
            If barCount = 0 Then
                MessageBox.Show("No bar codes found.")
                Me.DialogResult = DialogResult.Cancel

                ' Release the memory 
                VB_FullDemo.DTWAINAPI.DTWAIN_FreeExtImageInfo(m_Source)
                Return
            End If
            ...
            bOk = VB_FullDemo.DTWAINAPI.DTWAIN_GetExtImageInfoData(m_Source, DTWAINAPI.DTWAIN_EI_BARCODETEXT, aText)
            bOk = VB_FullDemo.DTWAINAPI.DTWAIN_GetExtImageInfoData(m_Source, DTWAINAPI.DTWAIN_EI_BARCODETYPE, aType)
            If bOk = 1 Then
                ...
                For i As Integer = 0 To barCount - 1
                    ...
                    VB_FullDemo.DTWAINAPI.DTWAIN_ArrayGetAtANSIString(aText, i, oneString)
                    szOrigText.AppendFormat("     Text: {0}\r\n", oneString.ToString())
                    Dim nType As Integer = 0
                    VB_FullDemo.DTWAINAPI.DTWAIN_ArrayGetAtLong(aType, i, nType)
                    ...
                    VB_FullDemo.DTWAINAPI.DTWAIN_GetTwainNameFromConstantEx(DTWAINAPI.DTWAIN_CONSTANT_TWBT, nType, szType, 100)
            ...
            VB_FullDemo.DTWAINAPI.DTWAIN_ArrayDestroy(aText)
            VB_FullDemo.DTWAINAPI.DTWAIN_ArrayDestroy(aType)
        End If
    End Sub
End Class
