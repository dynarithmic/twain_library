...
Public Class DibDisplayerDlg
    ...
    Private Sub DisplayTheDib()
        ...
        Else
            dib = VB_FullDemo.DTWAINAPI.DTWAIN_GetAcquiredImage(AcquireArray, nCurrentAcquisition, nCurDib)
            If dib <> 0 Then
    ...
    Private Shared Function BitmapFromDIB(ByVal pDIB As IntPtr) As Bitmap
        Return Bitmap.FromHbitmap(VB_FullDemo.DTWAINAPI.DTWAIN_ConvertDIBToBitmap(pDIB, System.IntPtr.Zero), System.IntPtr.Zero)
    End Function

    Private Sub EnablePageButtons()
        Dim nCount As Integer = VB_FullDemo.DTWAINAPI.DTWAIN_GetNumAcquiredImages(AcquireArray, nCurrentAcquisition)
    ...
    Private Sub DibDisplayerDlg_Unload(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        ...
        Next
        VB_FullDemo.DTWAINAPI.DTWAIN_DestroyAcquisitionArray(AcquireArray, 1)
    End Sub
    ...
    Private Sub DibDisplayerDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        nCurDib = 0
        Dim nCount As Integer = VB_FullDemo.DTWAINAPI.DTWAIN_GetNumAcquisitions(AcquireArray)
