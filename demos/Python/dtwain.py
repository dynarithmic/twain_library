...
def setup_windll(theDLL):
     ...
     #set up functions that take floating point parameters
     theDLL.DTWAIN_ArrayAddFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_ArrayAddFloatN.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_long]
     theDLL.DTWAIN_ArrayFindFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_ArrayGetAtFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_ArrayGetAtFrame.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_ArrayInsertAtFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double]
     theDLL.DTWAIN_ArrayInsertAtFloatN.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double, ct.c_long]
     theDLL.DTWAIN_ArraySetAtFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double]
     theDLL.DTWAIN_ArraySetAtFrame.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double, ct.c_double, ct.c_double]
     theDLL.DTWAIN_FrameCreate.argtypes = [ct.c_double, ct.c_double, ct.c_double, ct.c_double]
     theDLL.DTWAIN_FrameGetAll.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_FrameGetValue.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_FrameSetAll.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double, ct.c_double, ct.c_double]
     theDLL.DTWAIN_FrameSetValue.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double]
     theDLL.DTWAIN_GetAcquireArea2.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_long)]
     theDLL.DTWAIN_GetBrightness.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetContrast.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetDoubleFeedDetectLength.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.c_long]
     theDLL.DTWAIN_GetHighlight.argtypes = [ct.POINTER(ct.c_void_p),ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetImageInfo.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_long), ct.POINTER(ct.c_long), ct.POINTER(ct.c_long), ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_long),ct.POINTER(ct.c_long),ct.POINTER(ct.c_long),ct.POINTER(ct.c_long)]
     theDLL.DTWAIN_GetOCRTextInfoFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_long, ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetOCRTextInfoFloatEx.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.POINTER(ct.c_double), ct.c_long]
     theDLL.DTWAIN_GetPDFTextElementFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.c_long]
     theDLL.DTWAIN_GetResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetRotation.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetShadow.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetThreshold.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetXResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_GetYResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_IsDIBBlank.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_IsDoubleFeedDetectLengthSupported.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_RangeGetAllFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double), ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_RangeGetExpValueFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_RangeGetPosFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.POINTER(ct.c_long)]
     theDLL.DTWAIN_RangeGetValueFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.POINTER(ct.c_double)]
     theDLL.DTWAIN_RangeNearestValueFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.POINTER(ct.c_double), ct.c_long]
     theDLL.DTWAIN_RangeSetAllFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double, ct.c_double, ct.c_double, ct.c_double]
     theDLL.DTWAIN_RangeSetValueFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double]
     theDLL.DTWAIN_SetAcquireArea2.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_long]
     theDLL.DTWAIN_SetAcquireImageScale.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double]
     theDLL.DTWAIN_SetBlankPageDetection.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_long, ct.c_long]
     theDLL.DTWAIN_SetBlankPageDetectionEx.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_long, ct.c_long, ct.c_long]
     theDLL.DTWAIN_SetBrightness.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetContrast.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetDoubleFeedDetectLength.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetHighlight.argtypes = [ct.POINTER(ct.c_void_p),ct.c_double]
     theDLL.DTWAIN_SetPDFPageScale.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double, ct.c_double]
     theDLL.DTWAIN_SetPDFPageSize.argtypes = [ct.POINTER(ct.c_void_p), ct.c_long, ct.c_double, ct.c_double]
     theDLL.DTWAIN_SetPDFTextElementFloat.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_double, ct.c_long]
     theDLL.DTWAIN_SetResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetRotation.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetShadow.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetThreshold.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double, ct.c_long]
     theDLL.DTWAIN_SetXResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
     theDLL.DTWAIN_SetYResolution.argtypes = [ct.POINTER(ct.c_void_p), ct.c_double]
