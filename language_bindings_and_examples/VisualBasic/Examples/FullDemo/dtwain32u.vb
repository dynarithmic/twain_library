...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_AcquireFileA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileType As Integer, ByVal lFileFlags As Integer, ByVal PixelType As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Ansi Function DTWAIN_AcquireAudioFileA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileFlags As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Ansi Function DTWAIN_AddPDFTextA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szText As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal fontName As String, ByVal fontSize As Double, ByVal colorRGB As Integer, ByVal renderMode As Integer, ByVal scaling As Double, ByVal charSpacing As Double, ByVal wordSpacing As Double, ByVal strokeWidth As Integer, ByVal Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayAddStringA Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddStringNA Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayFindStringA Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal pString As String) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtStringA Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtStringA Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As String) As Integer
    ...
    Declare Ansi Function DTWAIN_GetCapFromNameA Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Ansi Function DTWAIN_GetCaptionA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Ansi Function DTWAIN_GetContrastStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Ansi Function DTWAIN_GetCurrentFileNameA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szName As String, ByVal MaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetDSMFullNameA Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szDLLName As String, ByVal nMaxLen As Integer, ByRef pWhichSearch As Integer) As Integer
    Declare Ansi Function DTWAIN_GetDeviceTimeDateA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Ansi Function DTWAIN_GetErrorStringA Lib "DTWAIN32U.DLL" (ByVal lError As Integer, ByVal lpszBuffer As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetExtCapFromNameA Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Ansi Function DTWAIN_GetExtNameFromCapA Lib "DTWAIN32U.DLL" (ByVal nValue As Integer, ByVal szValue As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetImageInfoStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpXResolution As String, ByVal lpYResolution As String, ByRef lpWidth As Integer, ByRef lpLength As Integer, ByRef lpNumSamples As Integer, ByRef lpBitsPerSample As Integer, ByRef lpBitsPerPixel As Integer, ByRef lpPlanar As Integer, ByRef lpPixelType As Integer, ByRef lpCompression As Integer) As Integer
    Declare Ansi Function DTWAIN_GetNameFromCapA Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRManufacturerA Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szManufacturer As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRProductFamilyA Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductFamily As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRProductNameA Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductName As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRTextA Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal nPageNo As Integer, ByVal Data As String, ByVal dSize As Integer, ByRef pActualSize As Integer, ByVal nFlags As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRVersionInfoA Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal buffer As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPDFTextElementStringA Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer, ByVal szData As String, ByVal maxLen As Integer, ByVal Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPDFType1FontNameA Lib "DTWAIN32U.DLL" (ByVal FontVal As Integer, ByVal szFont As String, ByVal nChars As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPrinterSuffixStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetResolutionStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Resolution As String) As Integer
    Declare Ansi Function DTWAIN_GetRotationStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Rotation As String) As Integer
    Declare Ansi Function DTWAIN_GetSourceManufacturerA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductFamilyA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductNameA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceVersionInfoA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTempFileDirectoryA Lib "DTWAIN32U.DLL" (ByVal szFilePath As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTimeDateA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Ansi Function DTWAIN_GetVersionInfoA Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionStringA Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_IsDIBBlankStringA Lib "DTWAIN32U.DLL" (ByVal hDib As Integer, ByVal threshold As String) As Integer
    Declare Ansi Function DTWAIN_LoadCustomStringResourcesA Lib "DTWAIN32U.DLL" (ByVal sLangDLL As String) As Integer
    Declare Ansi Function DTWAIN_LogMessageA Lib "DTWAIN32U.DLL" (ByVal message As String) As Integer
    Declare Ansi Function DTWAIN_SelectOCREngineByNameA Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Ansi Function DTWAIN_SelectSource2A Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nOptions As Integer) As Integer
    Declare Ansi Function DTWAIN_SelectSourceByNameA Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Ansi Function DTWAIN_SetAcquireArea2StringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByVal lUnit As Integer, ByVal Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetAcquireImageScaleStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal xscale As String, ByVal yscale As String) As Integer
    Declare Ansi Function DTWAIN_SetAppInfoA Lib "DTWAIN32U.DLL" (ByVal szVerStr As String, ByVal szManu As String, ByVal szProdFam As String, ByVal szProdName As String) As Integer
    Declare Ansi Function DTWAIN_SetAuthorA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szAuthor As String) As Integer
    Declare Ansi Function DTWAIN_SetBlankPageDetectionStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal threshold As String, ByVal autodetect_option As Integer, ByVal bSet As Integer) As Integer
    Declare Ansi Function DTWAIN_SetBrightnessStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Ansi Function DTWAIN_SetCameraA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szCamera As String) As Integer
    Declare Ansi Function DTWAIN_SetCaptionA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Ansi Function DTWAIN_SetContrastStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Ansi Function DTWAIN_SetDeviceTimeDateA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Ansi Function DTWAIN_SetFileSavePosA Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nFlags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFAuthorA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpAuthor As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFCreatorA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpCreator As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFEncryptionA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bUseEncryption As Integer, ByVal lpszUser As String, ByVal lpszOwner As String, ByVal Permissions As Integer, ByVal UseStrongEncryption As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFKeywordsA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpKeyWords As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageScaleStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nOptions As Integer, ByVal xScale As String, ByVal yScale As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageSizeStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PageSize As Integer, ByVal CustomWidth As String, ByVal CustomHeight As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFProducerA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpProducer As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFSubjectA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpSubject As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFTitleA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpTitle As String) As Integer
    Declare Ansi Function DTWAIN_SetPostScriptTitleA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTitle As String) As Integer
    Declare Ansi Function DTWAIN_SetPrinterSuffixStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String) As Integer
    Declare Ansi Function DTWAIN_SetResolutionStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Resolution As String) As Integer
    Declare Ansi Function DTWAIN_SetRotationStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Rotation As String) As Integer
    Declare Ansi Function DTWAIN_SetTempFileDirectoryA Lib "DTWAIN32U.DLL" (ByVal szFilePath As String) As Integer
    Declare Ansi Function DTWAIN_SetTwainLogA Lib "DTWAIN32U.DLL" (ByVal LogFlags As Integer, ByVal lpszLogFile As String) As Integer
    Declare Ansi Function DTWAIN_StartTwainSessionA Lib "DTWAIN32U.DLL" (ByVal hWndMsg As IntPtr, ByVal lpszDLLName As String) As Integer
    Declare Ansi Function DTWAIN_SysInitializeEx2A Lib "DTWAIN32U.DLL" (ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Ansi Function DTWAIN_SysInitializeExA Lib "DTWAIN32U.DLL" (ByVal szINIPath As String) As Integer
    Declare Ansi Function DTWAIN_SysInitializeLibEx2A Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Ansi Function DTWAIN_SysInitializeLibExA Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String) As Integer
    Declare Ansi Function DTWAIN_TwainSaveA Lib "DTWAIN32U.DLL" (ByVal cmd As String) As Integer
    Declare Auto Function DTWAIN_AcquireBuffered Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireBufferedEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByVal Acquisitions As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireFile Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileType As Integer, ByVal lFileFlags As Integer, ByVal PixelType As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireAudioFile Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileFlags As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireFileEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal aFileNames As Integer, ByVal lFileType As Integer, ByVal lFileFlags As Integer, ByVal PixelType As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireNative Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireNativeEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByVal Acquisitions As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireAudioNative Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireAudioNativeEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByVal Acquisitions As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AcquireToClipboard Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal nMaxPages As Integer, ByVal nTransferMode As Integer, ByVal bDiscardDibs As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_AddPDFText Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szText As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal fontName As String, ByVal fontSize As Double, ByVal colorRGB As Integer, ByVal renderMode As Integer, ByVal scaling As Double, ByVal charSpacing As Double, ByVal wordSpacing As Double, ByVal strokeWidth As Integer, ByVal Flags As Integer) As Integer
    Declare Auto Function DTWAIN_AppHandlesExceptions Lib "DTWAIN32U.DLL" (ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddANSIString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String) As Integer
    Declare Auto Function DTWAIN_ArrayAddANSIStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Double) As Integer
    Declare Auto Function DTWAIN_ArrayAddFloatN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Double, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddLongN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Integer, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String) As Integer
    Declare Auto Function DTWAIN_ArrayAddStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddWideString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String) As Integer
    Declare Auto Function DTWAIN_ArrayAddWideStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayConvertFix32ToFloat Lib "DTWAIN32U.DLL" (ByVal Fix32Array As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayConvertFloatToFix32 Lib "DTWAIN32U.DLL" (ByVal FloatArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayCopy Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Dest As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayCreate Lib "DTWAIN32U.DLL" (ByVal nEnumType As Integer, ByVal nInitialSize As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayCreateCopy Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayCreateFromCap Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCapType As Integer, ByVal lSize As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayCreateFromLongs Lib "DTWAIN32U.DLL" (ByRef pCArray As Integer, ByVal nSize As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayDestroy Lib "DTWAIN32U.DLL" (ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayDestroyFrames Lib "DTWAIN32U.DLL" (ByVal FrameArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayFindANSIString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal pString As String) As Integer
    Declare Auto Function DTWAIN_ArrayFindFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Double, ByVal Tolerance As Double) As Integer
    ...
    Declare Auto Function DTWAIN_ArrayGetAtLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByRef pVal As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtWideString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Auto Function DTWAIN_ArrayGetBuffer Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nPos As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayGetCount Lib "DTWAIN32U.DLL" (ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayGetMaxStringLength Lib "DTWAIN32U.DLL" (ByVal a As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayGetStringLength Lib "DTWAIN32U.DLL" (ByVal a As Integer, ByVal nWhichString As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayGetType Lib "DTWAIN32U.DLL" (ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtANSIString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As String) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtANSIStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As Double) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFloatN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal Val As Double, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtLongN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As Integer, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As String) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtWideString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As String) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtWideStringN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayRemoveAll Lib "DTWAIN32U.DLL" (ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayRemoveAt Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayRemoveAtN Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayResize Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal NewSize As Integer) As Integer
    Declare Auto Function DTWAIN_ArraySetAtANSIString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As Double) As Integer
    Declare Auto Function DTWAIN_ArraySetAtLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pVal As Integer) As Integer
    Declare Auto Function DTWAIN_ArraySetAtString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Auto Function DTWAIN_ArraySetAtWideString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Auto Function DTWAIN_CallCallback Lib "DTWAIN32U.DLL" (ByVal wParam As Integer, ByVal lParam As Integer, ByVal UserData As Integer) As Integer
    Declare Auto Function DTWAIN_ClearBuffers Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal ClearBuffer As Integer) As Integer
    Declare Auto Function DTWAIN_ClearErrorBuffer Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_ClearPDFText Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_ClearPage Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_CloseSource Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_CloseSourceUI Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_CreateAcquisitionArray Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_CreatePDFTextElement Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_DestroyAcquisitionArray Lib "DTWAIN32U.DLL" (ByVal aAcq As Integer, ByVal bDestroyData As Integer) As Integer
    Declare Auto Function DTWAIN_DestroyPDFTextElement Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer) As Integer
    Declare Auto Function DTWAIN_DisableAppWindow Lib "DTWAIN32U.DLL" (ByVal hWnd As IntPtr, ByVal bDisable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoBorderDetect Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoBright Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoDeskew Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoFeed Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoRotate Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnableAutoScan Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableDuplex Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableFeeder Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnableIndicator Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableJobFileHandling Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnableLamp Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableMsgNotify Lib "DTWAIN32U.DLL" (ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_EnablePatchDetect Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnablePrinter Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EnableThumbnail Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bEnable As Integer) As Integer
    Declare Auto Function DTWAIN_EndThread Lib "DTWAIN32U.DLL" (ByVal DLLHandle As Integer) As Integer
    Declare Auto Function DTWAIN_EndTwainSession Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_EnumAlarms Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumBitDepths Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumBottomCameras Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Cameras As Integer) As Integer
    Declare Auto Function DTWAIN_EnumBrightnessValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer, ByVal bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumCameras Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Cameras As Integer) As Integer
    Declare Auto Function DTWAIN_EnumCompressionTypes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumContrastValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer, ByVal bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumCustomCaps Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumExtImageInfoTypes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumExtendedCaps Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumFileXferFormats Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumHighlightValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer, ByVal bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumJobControls Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumLightPaths Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef LightPath As Integer) As Integer
    Declare Auto Function DTWAIN_EnumLightSources Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef LightSources As Integer) As Integer
    Declare Auto Function DTWAIN_EnumMaxBuffers Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pMaxBufs As Integer, ByVal bExpandRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumNoiseFilters Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_EnumPatchPriorities Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumPatchSearchModes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumPatchTimeOutValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumPixelTypes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumPrinterStringModes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumResolutionValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer, ByVal bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumSourceUnits Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumSources Lib "DTWAIN32U.DLL" (ByRef lpArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumSupportedCaps Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumSupportedCapsEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal MaxCustomBase As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_EnumThresholdValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer, ByVal bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumTopCameras Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Cameras As Integer) As Integer
    Declare Auto Function DTWAIN_EnumTwainPrinters Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpAvailPrinters As Integer) As Integer
    Declare Auto Function DTWAIN_EnumTwainPrintersArray Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_ExecuteOCR Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szFileName As String, ByVal nStartPage As Integer, ByVal nEndPage As Integer) As Integer
    Declare Auto Function DTWAIN_FeedPage Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_FlipBitmap Lib "DTWAIN32U.DLL" (ByVal hDib As Integer) As Integer
    Declare Auto Function DTWAIN_FlushAcquiredPages Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_ForceAcquireBitDepth Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal BitDepth As Integer) As Integer
    Declare Auto Function DTWAIN_FrameCreate Lib "DTWAIN32U.DLL" (ByVal Left As Double, ByVal Top As Double, ByVal Right As Double, ByVal Bottom As Double) As Integer
    Declare Auto Function DTWAIN_FrameCreateString Lib "DTWAIN32U.DLL" (ByVal Left As String, ByVal Top As String, ByVal Right As String, ByVal Bottom As String) As Integer
    Declare Auto Function DTWAIN_FrameDestroy Lib "DTWAIN32U.DLL" (ByVal Frame As Integer) As Integer
    Declare Auto Function DTWAIN_FrameGetAll Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByRef Left As Double, ByRef Top As Double, ByRef Right As Double, ByRef Bottom As Double) As Integer
    Declare Auto Function DTWAIN_FrameGetAllString Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal Left As String, ByVal Top As String, ByVal Right As String, ByVal Bottom As String) As Integer
    Declare Auto Function DTWAIN_FrameGetValue Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal nWhich As Integer, ByRef Value As Double) As Integer
    Declare Auto Function DTWAIN_FrameGetValueString Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal nWhich As Integer, ByVal Value As String) As Integer
    Declare Auto Function DTWAIN_FrameIsValid Lib "DTWAIN32U.DLL" (ByVal Frame As Integer) As Integer
    Declare Auto Function DTWAIN_FrameSetAll Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal Left As Double, ByVal Top As Double, ByVal Right As Double, ByVal Bottom As Double) As Integer
    Declare Auto Function DTWAIN_FrameSetAllString Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal Left As String, ByVal Top As String, ByVal Right As String, ByVal Bottom As String) As Integer
    Declare Auto Function DTWAIN_FrameSetValue Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal nWhich As Integer, ByVal Value As Double) As Integer
    Declare Auto Function DTWAIN_FrameSetValueString Lib "DTWAIN32U.DLL" (ByVal Frame As Integer, ByVal nWhich As Integer, ByVal Value As String) As Integer
    ...
    Declare Auto Function DTWAIN_GetAcquiredImage Lib "DTWAIN32U.DLL" (ByVal aAcq As Integer, ByVal nWhichAcq As Integer, ByVal nWhichDib As Integer) As Integer
    Declare Auto Function DTWAIN_GetAcquiredImageArray Lib "DTWAIN32U.DLL" (ByVal aAcq As Integer, ByVal nWhichAcq As Integer) As Integer
    Declare Auto Function DTWAIN_GetAlarmVolume Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpVolume As Integer) As Integer
    Declare Auto Function DTWAIN_GetAppInfo Lib "DTWAIN32U.DLL" (ByVal szVerStr As String, ByVal szManu As String, ByVal szProdFam As String, ByVal szProdName As String) As Integer
    Declare Auto Function DTWAIN_GetAuthor Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szAuthor As String) As Integer
    Declare Auto Function DTWAIN_GetBatteryMinutes Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpMinutes As Integer) As Integer
    Declare Auto Function DTWAIN_GetBatteryPercent Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpPercent As Integer) As Integer
    Declare Auto Function DTWAIN_GetBitDepth Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef BitDepth As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetBlankPageAutoDetection Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetBrightness Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Brightness As Double) As Integer
    Declare Auto Function DTWAIN_GetBrightnessString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Brightness As String) As Integer
    ...
    Declare Auto Function DTWAIN_GetCapArrayType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nCap As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapContainer Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nCap As Integer, ByVal lCapType As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapContainerEx Lib "DTWAIN32U.DLL" (ByVal nCap As Integer, ByVal bSetContainer As Integer, ByRef ConTypes As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapDataType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nCap As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapFromName Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Auto Function DTWAIN_GetCapOperations Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCapability As Integer, ByRef lpOps As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lGetType As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapValuesEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lGetType As Integer, ByVal lContainerType As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_GetCapValuesEx2 Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lGetType As Integer, ByVal lContainerType As Integer, ByVal nDataType As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_GetCaption Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Auto Function DTWAIN_GetCompressionSize Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lBytes As Integer) As Integer
    Declare Auto Function DTWAIN_GetCompressionType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpCompression As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetContrast Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Contrast As Double) As Integer
    Declare Auto Function DTWAIN_GetContrastString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Auto Function DTWAIN_GetCountry Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetCurrentAcquiredImage Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetCurrentFileName Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szName As String, ByVal MaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetCurrentPageNum Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetCurrentRetryCount Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetCustomDSData Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Data As Integer, ByVal dSize As Integer, ByRef pActualSize As Integer, ByVal nFlags As Integer) As Integer
    Declare Auto Function DTWAIN_GetDSMFullName Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szDLLName As String, ByVal nMaxLen As Integer, ByRef pWhichSearch As Integer) As Integer
    Declare Auto Function DTWAIN_GetDSMSearchOrder Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetDTWAINHandle Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetDeviceEvent Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpEvent As Integer) As Integer
    Declare Auto Function DTWAIN_GetDeviceEventEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpEvent As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_GetDeviceNotifications Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef DevEvents As Integer) As Integer
    Declare Auto Function DTWAIN_GetDeviceTimeDate Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Auto Function DTWAIN_GetDuplexType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpDupType As Integer) As Integer
    Declare Auto Function DTWAIN_GetErrorBuffer Lib "DTWAIN32U.DLL" (ByRef ArrayBuffer As Integer) As Integer
    Declare Auto Function DTWAIN_GetErrorBufferThreshold Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetErrorString Lib "DTWAIN32U.DLL" (ByVal lError As Integer, ByVal lpszBuffer As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetExtCapFromName Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Auto Function DTWAIN_GetExtImageInfo Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetExtImageInfoData Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nWhich As Integer, ByRef Data As Integer) As Integer
    Declare Auto Function DTWAIN_GetExtNameFromCap Lib "DTWAIN32U.DLL" (ByVal nValue As Integer, ByVal szValue As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetFeederAlignment Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpAlignment As Integer) As Integer
    Declare Auto Function DTWAIN_GetFeederFuncs Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetFeederOrder Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpOrder As Integer) As Integer
    Declare Auto Function DTWAIN_GetHighlight Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Highlight As Double) As Integer
    Declare Auto Function DTWAIN_GetHighlightString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_GetHighlightStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_GetHighlightStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_GetImageInfo Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpXResolution As Double, ByRef lpYResolution As Double, ByRef lpWidth As Integer, ByRef lpLength As Integer, ByRef lpNumSamples As Integer, ByRef lpBitsPerSample As Integer, ByRef lpBitsPerPixel As Integer, ByRef lpPlanar As Integer, ByRef lpPixelType As Integer, ByRef lpCompression As Integer) As Integer
    Declare Auto Function DTWAIN_GetImageInfoString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpXResolution As String, ByVal lpYResolution As String, ByRef lpWidth As Integer, ByRef lpLength As Integer, ByRef lpNumSamples As Integer, ByRef lpBitsPerSample As Integer, ByRef lpBitsPerPixel As Integer, ByRef lpPlanar As Integer, ByRef lpPixelType As Integer, ByRef lpCompression As Integer) As Integer
    Declare Auto Function DTWAIN_GetJobControl Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pJobControl As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetJpegValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetLightPath Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpLightPath As Integer) As Integer
    Declare Auto Function DTWAIN_GetLightSources Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef LightSources As Integer) As Integer
    Declare Auto Function DTWAIN_GetManualDuplexCount Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pSide1 As Integer, ByRef pSide2 As Integer) As Integer
    Declare Auto Function DTWAIN_GetMaxAcquisitions Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetMaxBuffers Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pMaxBuf As Integer) As Integer
    Declare Auto Function DTWAIN_GetMaxPagesToAcquire Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetMaxRetryAttempts Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_GetNameFromCap Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetNoiseFilter Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpNoiseFilter As Integer) As Integer
    Declare Auto Function DTWAIN_GetNumAcquiredImages Lib "DTWAIN32U.DLL" (ByVal aAcq As Integer, ByVal nWhich As Integer) As Integer
    Declare Auto Function DTWAIN_GetNumAcquisitions Lib "DTWAIN32U.DLL" (ByVal aAcq As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRCapValues Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal OCRCapValue As Integer, ByVal nGetType As Integer, ByRef CapValues As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRLastError Lib "DTWAIN32U.DLL" (ByVal Engine As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRManufacturer Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szManufacturer As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRProductFamily Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductFamily As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRProductName Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductName As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRText Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal nPageNo As Integer, ByVal Data As String, ByVal dSize As Integer, ByRef pActualSize As Integer, ByVal nFlags As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRTextInfoFloat Lib "DTWAIN32U.DLL" (ByVal OCRTextInfo As Integer, ByVal nCharPos As Integer, ByVal nWhichItem As Integer, ByRef pInfo As Double) As Integer
    Declare Auto Function DTWAIN_GetOCRTextInfoFloatEx Lib "DTWAIN32U.DLL" (ByVal OCRTextInfo As Integer, ByVal nWhichItem As Integer, ByRef pInfo As Double, ByVal bufSize As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRTextInfoHandle Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal nPageNo As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRTextInfoLong Lib "DTWAIN32U.DLL" (ByVal OCRTextInfo As Integer, ByVal nCharPos As Integer, ByVal nWhichItem As Integer, ByRef pInfo As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetPDFType1FontName Lib "DTWAIN32U.DLL" (ByVal FontVal As Integer, ByVal szFont As String, ByVal nChars As Integer) As Integer
    Declare Auto Function DTWAIN_GetPaperSize Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpPaperSize As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPatchMaxPriorities Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pMaxPriorities As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPatchMaxRetries Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pMaxRetries As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPatchPriorities Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef SearchPriorities As Integer) As Integer
    Declare Auto Function DTWAIN_GetPatchSearchMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pSearchMode As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPatchTimeOut Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pTimeOut As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPixelFlavor Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpPixelFlavor As Integer) As Integer
    Declare Auto Function DTWAIN_GetPixelType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef PixelType As Integer, ByRef BitDepth As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPrinter Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpPrinter As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPrinterStartNumber Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef nStart As Integer) As Integer
    Declare Auto Function DTWAIN_GetPrinterStringMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef PrinterMode As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_GetPrinterStrings Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef ArrayString As Integer) As Integer
    Declare Auto Function DTWAIN_GetPrinterSuffixString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetRegisteredMsg Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetResolution Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Resolution As Double) As Integer
    ...
    Declare Auto Function DTWAIN_GetSourceProductFamily Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceProductName Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceUnit Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef lpUnit As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceVersionInfo Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceVersionNumber Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef pMajor As Integer, ByRef pMinor As Integer) As Integer
    Declare Auto Function DTWAIN_GetStaticLibVersion Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetTempFileDirectory Lib "DTWAIN32U.DLL" (ByVal szFilePath As String, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetThreshold Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByRef Threshold As Double) As Integer
    Declare Auto Function DTWAIN_GetThresholdString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String) As Integer
    Declare Auto Function DTWAIN_GetThresholdStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String) As Integer
    Declare Auto Function DTWAIN_GetThresholdStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String) As Integer
    Declare Auto Function DTWAIN_GetTimeDate Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Auto Function DTWAIN_GetTwainAppID Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetTwainAvailability Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_GetTwainHwnd Lib  "DTWAIN32U.DLL" () As Integer
    ...
    Declare Auto Function DTWAIN_GetVersionInfo Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Auto Function DTWAIN_GetVersionString Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Auto Function DTWAIN_InitExtImageInfo Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsAutoBorderDetectEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsAutoBorderDetectSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsAutoBrightEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsAutoBrightSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsAutoDeskewEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsAutoDeskewSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsCompressionSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Compression As Integer) As Integer
    Declare Auto Function DTWAIN_IsCustomDSDataSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsDIBBlank Lib "DTWAIN32U.DLL" (ByVal hDib As Integer, ByVal threshold As Double) As Integer
    Declare Auto Function DTWAIN_IsDIBBlankString Lib "DTWAIN32U.DLL" (ByVal hDib As Integer, ByVal threshold As String) As Integer
    Declare Auto Function DTWAIN_IsDeviceEventSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsDeviceOnLine Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsDuplexEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsDuplexSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsExtImageInfoSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFeederEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFeederLoaded Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFeederSensitive Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFeederSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFileSystemSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsFileXferSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lFileType As Integer) As Integer
    Declare Auto Function DTWAIN_IsIndicatorEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsIndicatorSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsJobControlSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal JobControl As Integer) As Integer
    Declare Auto Function DTWAIN_IsLampEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsLampSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsLightPathSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsLightSourceSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsMaxBuffersSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal MaxBuf As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsPaperSizeSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PaperSize As Integer) As Integer
    Declare Auto Function DTWAIN_IsPatchCapsSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsPatchDetectEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsPatchSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PatchCode As Integer) As Integer
    Declare Auto Function DTWAIN_IsPixelTypeSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer) As Integer
    Declare Auto Function DTWAIN_IsPrinterEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Printer As Integer) As Integer
    Declare Auto Function DTWAIN_IsPrinterSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsSessionEnabled Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_IsSkipImageInfoError Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsSourceAcquiring Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsSourceOpen Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsTIFFSupported Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_IsThumbnailEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsThumbnailSupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsTwainAvailable Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_IsTwainMsg Lib "DTWAIN32U.DLL" (ByVal pMsg As WinMsg) As Integer
    Declare Auto Function DTWAIN_IsUIControllable Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsUIEnabled Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_IsUIOnlySupported Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_LoadCustomStringResources Lib "DTWAIN32U.DLL" (ByVal sLangDLL As String) As Integer
    Declare Auto Function DTWAIN_LoadLanguageResource Lib "DTWAIN32U.DLL" (ByVal nLanguage As Integer) As Integer
    Declare Auto Function DTWAIN_LogMessage Lib "DTWAIN32U.DLL" (ByVal message As String) As Integer
    Declare Auto Function DTWAIN_OpenSource Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_OpenSourcesOnSelect Lib "DTWAIN32U.DLL" (ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_RangeCreate Lib "DTWAIN32U.DLL" (ByVal nEnumType As Integer) As Integer
    Declare Auto Function DTWAIN_RangeCreateFromCap Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCapType As Integer) As Integer
    Declare Auto Function DTWAIN_RangeDestroy Lib "DTWAIN32U.DLL" (ByVal pSource As Integer) As Integer
    Declare Auto Function DTWAIN_RangeExpand Lib "DTWAIN32U.DLL" (ByVal pSource As Integer, ByRef pArray As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetAllFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByRef pVariantLow As Double, ByRef pVariantUp As Double, ByRef pVariantStep As Double, ByRef pVariantDefault As Double, ByRef pVariantCurrent As Double) As Integer
    Declare Auto Function DTWAIN_RangeGetAllFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal dLow As String, ByVal dUp As String, ByVal dStep As String, ByVal dDefault As String, ByVal dCurrent As String) As Integer
    Declare Auto Function DTWAIN_RangeGetAllLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByRef pVariantLow As Integer, ByRef pVariantUp As Integer, ByRef pVariantStep As Integer, ByRef pVariantDefault As Integer, ByRef pVariantCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetCount Lib "DTWAIN32U.DLL" (ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetExpValueFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal lPos As Integer, ByRef pVal As Double) As Integer
    Declare Auto Function DTWAIN_RangeGetExpValueFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal lPos As Integer, ByVal pVal As String) As Integer
    Declare Auto Function DTWAIN_RangeGetExpValueLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal lPos As Integer, ByRef pVal As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetPosFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As Double, ByRef pPos As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetPosFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByRef pPos As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetPosLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Value As Integer, ByRef pPos As Integer) As Integer
    Declare Auto Function DTWAIN_RangeGetValueFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByRef pVal As Double) As Integer
    Declare Auto Function DTWAIN_RangeGetValueFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByVal pVal As String) As Integer
    Declare Auto Function DTWAIN_RangeGetValueLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByRef pVal As Integer) As Integer
    Declare Auto Function DTWAIN_RangeIsValid Lib "DTWAIN32U.DLL" (ByVal Range As Integer, ByRef pStatus As Integer) As Integer
    Declare Auto Function DTWAIN_RangeNearestValueFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal dIn As Double, ByRef pOut As Double, ByVal RoundType As Integer) As Integer
    Declare Auto Function DTWAIN_RangeNearestValueFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal dIn As String, ByVal pOut As String, ByVal RoundType As Integer) As Integer
    Declare Auto Function DTWAIN_RangeNearestValueLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal lIn As Integer, ByRef pOut As Integer, ByVal RoundType As Integer) As Integer
    Declare Auto Function DTWAIN_RangeSetAllFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal dLow As Double, ByVal dUp As Double, ByVal dStep As Double, ByVal dDefault As Double, ByVal dCurrent As Double) As Integer
    Declare Auto Function DTWAIN_RangeSetAllFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal dLow As String, ByVal dUp As String, ByVal dStep As String, ByVal dDefault As String, ByVal dCurrent As String) As Integer
    Declare Auto Function DTWAIN_RangeSetAllLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal lLow As Integer, ByVal lUp As Integer, ByVal lStep As Integer, ByVal lDefault As Integer, ByVal lCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_RangeSetValueFloat Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByVal Val As Double) As Integer
    Declare Auto Function DTWAIN_RangeSetValueFloatString Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByVal Val As String) As Integer
    Declare Auto Function DTWAIN_RangeSetValueLong Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhich As Integer, ByVal Val As Integer) As Integer
    Declare Auto Function DTWAIN_ResetPDFTextElement Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer) As Integer
    Declare Auto Function DTWAIN_RewindPage Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_SelectDefaultOCREngine Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SelectDefaultSource Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SelectOCREngine Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SelectOCREngineByName Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Auto Function DTWAIN_SelectSource Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SelectSource2 Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nOptions As Integer) As Integer
    Declare Auto Function DTWAIN_SelectSourceByName Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Auto Function DTWAIN_SetAcquireArea Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lSetType As Integer, ByVal FloatEnum As Integer, ByVal ActualEnum As Integer) As Integer
    Declare Auto Function DTWAIN_SetAcquireArea2 Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal left As Double, ByVal top As Double, ByVal right As Double, ByVal bottom As Double, ByVal lUnit As Integer, ByVal Flags As Integer) As Integer
    Declare Auto Function DTWAIN_SetAcquireArea2String Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByVal lUnit As Integer, ByVal Flags As Integer) As Integer
    Declare Auto Function DTWAIN_SetAcquireImageNegative Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal IsNegative As Integer) As Integer
    Declare Auto Function DTWAIN_SetAcquireImageScale Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal xscale As Double, ByVal yscale As Double) As Integer
    Declare Auto Function DTWAIN_SetAcquireImageScaleString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal xscale As String, ByVal yscale As String) As Integer
    Declare Auto Function DTWAIN_SetAcquireStripBuffer Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal hMem As Integer) As Integer
    Declare Auto Function DTWAIN_SetAlarmVolume Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Volume As Integer) As Integer
    Declare Auto Function DTWAIN_SetAlarms Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Alarms As Integer) As Integer
    Declare Auto Function DTWAIN_SetAllCapsToDefault Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_SetAppInfo Lib "DTWAIN32U.DLL" (ByVal szVerStr As String, ByVal szManu As String, ByVal szProdFam As String, ByVal szProdName As String) As Integer
    Declare Auto Function DTWAIN_SetAuthor Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szAuthor As String) As Integer
    Declare Auto Function DTWAIN_SetAvailablePrinters Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpAvailPrinters As Integer) As Integer
    Declare Auto Function DTWAIN_SetAvailablePrintersArray Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal AvailPrinters As Integer) As Integer
    Declare Auto Function DTWAIN_SetBitDepth Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal BitDepth As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetBlankPageDetection Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal threshold As Double, ByVal autodetect_option As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetBlankPageDetectionString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal threshold As String, ByVal autodetect_option As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetBrightness Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Brightness As Double) As Integer
    Declare Auto Function DTWAIN_SetBrightnessString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Brightness As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetCamera Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szCamera As String) As Integer
    Declare Auto Function DTWAIN_SetCapValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lSetType As Integer, ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_SetCapValuesEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lSetType As Integer, ByVal lContainerType As Integer, ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_SetCapValuesEx2 Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCap As Integer, ByVal lSetType As Integer, ByVal lContainerType As Integer, ByVal nDataType As Integer, ByVal pArray As Integer) As Integer
    Declare Auto Function DTWAIN_SetCaption Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Auto Function DTWAIN_SetCompressionType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lCompression As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetContrast Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As Double) As Integer
    Declare Auto Function DTWAIN_SetContrastString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Auto Function DTWAIN_SetCountry Lib "DTWAIN32U.DLL" (ByVal nCountry As Integer) As Integer
    Declare Auto Function DTWAIN_SetCurrentRetryCount Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nCount As Integer) As Integer
    Declare Auto Function DTWAIN_SetCustomDSData Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal hData As Integer, ByRef Data As Integer, ByVal dSize As Integer, ByVal nFlags As Integer) As Integer
    Declare Auto Function DTWAIN_SetDSMSearchOrder Lib "DTWAIN32U.DLL" (ByVal SearchPath As Integer) As Integer
    Declare Auto Function DTWAIN_SetDefaultSource Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_SetDeviceNotifications Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal DevEvents As Integer) As Integer
    Declare Auto Function DTWAIN_SetDeviceTimeDate Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Auto Function DTWAIN_SetEOJDetectValue Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nValue As Integer) As Integer
    Declare Auto Function DTWAIN_SetErrorBufferThreshold Lib "DTWAIN32U.DLL" (ByVal nErrors As Integer) As Integer
    Declare Auto Function DTWAIN_SetFeederAlignment Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpAlignment As Integer) As Integer
    Declare Auto Function DTWAIN_SetFeederOrder Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lOrder As Integer) As Integer
    Declare Auto Function DTWAIN_SetFileAutoIncrement Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Increment As Integer, ByVal bResetOnAcquire As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetFileSavePos Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nFlags As Integer) As Integer
    Declare Auto Function DTWAIN_SetFileXferFormat Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lFileType As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetHighlight Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As Double) As Integer
    Declare Auto Function DTWAIN_SetHighlightString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_SetHighlightStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_SetHighlightStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Highlight As String) As Integer
    Declare Auto Function DTWAIN_SetJobControl Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal JobControl As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetJpegValues Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Quality As Integer, ByVal Progressive As Integer) As Integer
    Declare Auto Function DTWAIN_SetLanguage Lib "DTWAIN32U.DLL" (ByVal nLanguage As Integer) As Integer
    Declare Auto Function DTWAIN_SetLightPath Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal LightPath As Integer) As Integer
    Declare Auto Function DTWAIN_SetLightPathEx Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal LightPaths As Integer) As Integer
    Declare Auto Function DTWAIN_SetLightSources Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal LightSources As Integer) As Integer
    Declare Auto Function DTWAIN_SetManualDuplexMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Flags As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetMaxAcquisitions Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal MaxAcquires As Integer) As Integer
    Declare Auto Function DTWAIN_SetMaxBuffers Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal MaxBuf As Integer) As Integer
    Declare Auto Function DTWAIN_SetMaxRetryAttempts Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nAttempts As Integer) As Integer
    Declare Auto Function DTWAIN_SetMultipageScanMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal ScanType As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetPDFCreator Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpCreator As String) As Integer
    Declare Auto Function DTWAIN_SetPDFEncryption Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bUseEncryption As Integer, ByVal lpszUser As String, ByVal lpszOwner As String, ByVal Permissions As Integer, ByVal UseStrongEncryption As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFJpegQuality Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Quality As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFKeywords Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpKeyWords As String) As Integer
    Declare Auto Function DTWAIN_SetPDFOCRConversion Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal PageType As Integer, ByVal FileType As Integer, ByVal PixelType As Integer, ByVal BitDepth As Integer, ByVal Options As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFOCRMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFOrientation Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lPOrientation As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFPageScale Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nOptions As Integer, ByVal xScale As Double, ByVal yScale As Double) As Integer
    Declare Auto Function DTWAIN_SetPDFPageScaleString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nOptions As Integer, ByVal xScale As String, ByVal yScale As String) As Integer
    Declare Auto Function DTWAIN_SetPDFPageSize Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PageSize As Integer, ByVal CustomWidth As Double, ByVal CustomHeight As Double) As Integer
    Declare Auto Function DTWAIN_SetPDFPageSizeString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PageSize As Integer, ByVal CustomWidth As String, ByVal CustomHeight As String) As Integer
    Declare Auto Function DTWAIN_SetPDFProducer Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpProducer As String) As Integer
    Declare Auto Function DTWAIN_SetPDFSubject Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpSubject As String) As Integer
    Declare Auto Function DTWAIN_SetPDFTextElementFloat Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer, ByVal val1 As Double, ByVal val2 As Double, ByVal Flags As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFTextElementLong Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer, ByVal val1 As Integer, ByVal val2 As Integer, ByVal Flags As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFTitle Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpTitle As String) As Integer
    Declare Auto Function DTWAIN_SetPaperSize Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PaperSize As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetPatchMaxPriorities Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nMaxSearchRetries As Integer) As Integer
    Declare Auto Function DTWAIN_SetPatchMaxRetries Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nMaxRetries As Integer) As Integer
    Declare Auto Function DTWAIN_SetPatchPriorities Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal SearchPriorities As Integer) As Integer
    Declare Auto Function DTWAIN_SetPatchSearchMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nSearchMode As Integer) As Integer
    Declare Auto Function DTWAIN_SetPatchTimeOut Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal TimeOutValue As Integer) As Integer
    Declare Auto Function DTWAIN_SetPixelFlavor Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelFlavor As Integer) As Integer
    Declare Auto Function DTWAIN_SetPixelType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PixelType As Integer, ByVal BitDepth As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetPostScriptTitle Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTitle As String) As Integer
    Declare Auto Function DTWAIN_SetPostScriptType Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PSType As Integer) As Integer
    Declare Auto Function DTWAIN_SetPrinter Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Printer As Integer, ByVal bCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetPrinterStartNumber Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nStart As Integer) As Integer
    Declare Auto Function DTWAIN_SetPrinterStringMode Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PrinterMode As Integer, ByVal bSetCurrent As Integer) As Integer
    Declare Auto Function DTWAIN_SetPrinterStrings Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal ArrayString As Integer, ByRef pNumStrings As Integer) As Integer
    Declare Auto Function DTWAIN_SetPrinterSuffixString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String) As Integer
    Declare Auto Function DTWAIN_SetQueryCapSupport Lib "DTWAIN32U.DLL" (ByVal bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetResolution Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Resolution As Double) As Integer
    ...
    Declare Auto Function DTWAIN_SetTempFileDirectory Lib "DTWAIN32U.DLL" (ByVal szFilePath As String) As Integer
    Declare Auto Function DTWAIN_SetThreshold Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As Double, ByVal bSetBithDepthReduction As Integer) As Integer
    Declare Auto Function DTWAIN_SetThresholdString Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String, ByVal bSetBitDepthReduction As Integer) As Integer
    Declare Auto Function DTWAIN_SetThresholdStringA Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String, ByVal bSetBitDepthReduction As Integer) As Integer
    Declare Auto Function DTWAIN_SetThresholdStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Threshold As String, ByVal bSetBitDepthReduction As Integer) As Integer
    Declare Auto Function DTWAIN_SetTwainDialogFont Lib "DTWAIN32U.DLL" (ByVal hFont As Integer) As Integer
    Declare Auto Function DTWAIN_SetTwainDSM Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer) As Integer
    Declare Auto Function DTWAIN_SetTwainLog Lib "DTWAIN32U.DLL" (ByVal LogFlags As Integer, ByVal lpszLogFile As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetUpdateDibProc Lib "DTWAIN32U.DLL" (ByVal DibProc As DTWAINDibUpdateCallback) As DTWAINDibUpdateCallback
    Declare Auto Function DTWAIN_ShowUIOnly Lib "DTWAIN32U.DLL" (ByVal Source As Integer) As Integer
    Declare Auto Function DTWAIN_ShutdownOCREngine Lib "DTWAIN32U.DLL" (ByVal OCREngine As Integer) As Integer
    Declare Auto Function DTWAIN_SkipImageInfoError Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bSkip As Integer) As Integer
    Declare Auto Function DTWAIN_StartThread Lib "DTWAIN32U.DLL" (ByVal DLLHandle As Integer) As Integer
    Declare Auto Function DTWAIN_StartTwainSession Lib "DTWAIN32U.DLL" (ByVal hWndMsg As IntPtr, ByVal lpszDLLName As String) As Integer
    Declare Auto Function DTWAIN_SysDestroy Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SysInitialize Lib  "DTWAIN32U.DLL" () As Integer
    Declare Auto Function DTWAIN_SysInitializeEx Lib "DTWAIN32U.DLL" (ByVal szINIPath As String) As Integer
    Declare Auto Function DTWAIN_SysInitializeEx2 Lib "DTWAIN32U.DLL" (ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Auto Function DTWAIN_SysInitializeLib Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer) As Integer
    Declare Auto Function DTWAIN_SysInitializeLibEx Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String) As Integer
    Declare Auto Function DTWAIN_SysInitializeLibEx2 Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Auto Function DTWAIN_TwainSave Lib "DTWAIN32U.DLL" (ByVal cmd As String) As Integer
    Declare Auto Sub DTWAIN_X Lib "DTWAIN32U.DLL" (ByVal s As String) 
    Declare Unicode Function DTWAIN_AcquireFileW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileType As Integer, ByVal lFileFlags As Integer, ByVal PixelType As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Unicode Function DTWAIN_AcquireAudioFileW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpszFile As String, ByVal lFileFlags As Integer, ByVal lMaxPages As Integer, ByVal bShowUI As Integer, ByVal bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Unicode Function DTWAIN_AddPDFTextW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szText As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal fontName As String, ByVal fontSize As Double, ByVal colorRGB As Integer, ByVal renderMode As Integer, ByVal scaling As Double, ByVal charSpacing As Double, ByVal wordSpacing As Double, ByVal strokeWidth As Integer, ByVal Flags As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddStringNW Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddStringW Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal Val As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindStringW Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal pString As String) As Integer
    Declare Unicode Function DTWAIN_ArrayGetAtStringW Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal pStr As String) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtStringNW Lib "DTWAIN32U.DLL" (ByVal pArray As Integer, ByVal nWhere As Integer, ByVal Val As String, ByVal num As Integer) As Integer
    ...
    Declare Unicode Function DTWAIN_GetCapFromNameW Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Unicode Function DTWAIN_GetCaptionW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Unicode Function DTWAIN_GetContrastStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Unicode Function DTWAIN_GetCurrentFileNameW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szName As String, ByVal MaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetDSMFullNameW Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szDLLName As String, ByVal nMaxLen As Integer, ByRef pWhichSearch As Integer) As Integer
    Declare Unicode Function DTWAIN_GetDeviceTimeDateW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Unicode Function DTWAIN_GetErrorStringW Lib "DTWAIN32U.DLL" (ByVal lError As Integer, ByVal lpszBuffer As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetExtCapFromNameW Lib "DTWAIN32U.DLL" (ByVal szName As String) As Integer
    Declare Unicode Function DTWAIN_GetExtNameFromCapW Lib "DTWAIN32U.DLL" (ByVal nValue As Integer, ByVal szValue As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetImageInfoStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpXResolution As String, ByVal lpYResolution As String, ByRef lpWidth As Integer, ByRef lpLength As Integer, ByRef lpNumSamples As Integer, ByRef lpBitsPerSample As Integer, ByRef lpBitsPerPixel As Integer, ByRef lpPlanar As Integer, ByRef lpPixelType As Integer, ByRef lpCompression As Integer) As Integer
    Declare Unicode Function DTWAIN_GetNameFromCapW Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRManufacturerW Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szManufacturer As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRProductFamilyW Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductFamily As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRProductNameW Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal szProductName As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRTextW Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal nPageNo As Integer, ByVal Data As String, ByVal dSize As Integer, ByRef pActualSize As Integer, ByVal nFlags As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRVersionInfoW Lib "DTWAIN32U.DLL" (ByVal Engine As Integer, ByVal buffer As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetPDFTextElementStringW Lib "DTWAIN32U.DLL" (ByVal TextElement As Integer, ByVal szData As String, ByVal maxLen As Integer, ByVal Flags As Integer) As Integer
    Declare Unicode Function DTWAIN_GetPDFType1FontNameW Lib "DTWAIN32U.DLL" (ByVal FontVal As Integer, ByVal szFont As String, ByVal nChars As Integer) As Integer
    Declare Unicode Function DTWAIN_GetPrinterSuffixStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetResolutionStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Resolution As String) As Integer
    Declare Unicode Function DTWAIN_GetRotationStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Rotation As String) As Integer
    Declare Unicode Function DTWAIN_GetSourceManufacturerW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceProductFamilyW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceProductNameW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceVersionInfoW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szProduct As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTempFileDirectoryW Lib "DTWAIN32U.DLL" (ByVal szFilePath As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTimeDateW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Unicode Function DTWAIN_GetVersionInfoW Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetVersionStringW Lib "DTWAIN32U.DLL" (ByVal lpszVer As String, ByVal nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_IsDIBBlankStringW Lib "DTWAIN32U.DLL" (ByVal hDib As Integer, ByVal threshold As String) As Integer
    Declare Unicode Function DTWAIN_LoadCustomStringResourcesW Lib "DTWAIN32U.DLL" (ByVal sLangDLL As String) As Integer
    Declare Unicode Function DTWAIN_LogMessageW Lib "DTWAIN32U.DLL" (ByVal message As String) As Integer
    Declare Unicode Function DTWAIN_SelectOCREngineByNameW Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Unicode Function DTWAIN_SelectSource2W Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nOptions As Integer) As Integer
    Declare Unicode Function DTWAIN_SelectSourceByNameW Lib "DTWAIN32U.DLL" (ByVal lpszName As String) As Integer
    Declare Unicode Function DTWAIN_SetAcquireArea2StringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByVal lUnit As Integer, ByVal Flags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetAcquireImageScaleStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal xscale As String, ByVal yscale As String) As Integer
    Declare Unicode Function DTWAIN_SetAppInfoW Lib "DTWAIN32U.DLL" (ByVal szVerStr As String, ByVal szManu As String, ByVal szProdFam As String, ByVal szProdName As String) As Integer
    Declare Unicode Function DTWAIN_SetAuthorW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szAuthor As String) As Integer
    Declare Unicode Function DTWAIN_SetBlankPageDetectionStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal threshold As String, ByVal autodetect_option As Integer, ByVal bSet As Integer) As Integer
    Declare Unicode Function DTWAIN_SetBrightnessStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Unicode Function DTWAIN_SetCameraW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szCamera As String) As Integer
    Declare Unicode Function DTWAIN_SetCaptionW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Caption As String) As Integer
    Declare Unicode Function DTWAIN_SetContrastStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Contrast As String) As Integer
    Declare Unicode Function DTWAIN_SetDeviceTimeDateW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTimeDate As String) As Integer
    Declare Unicode Function DTWAIN_SetFileSavePosW Lib "DTWAIN32U.DLL" (ByVal hWndParent As IntPtr, ByVal szTitle As String, ByVal xPos As Integer, ByVal yPos As Integer, ByVal nFlags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetPDFAuthorW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpAuthor As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFCreatorW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpCreator As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFEncryptionW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal bUseEncryption As Integer, ByVal lpszUser As String, ByVal lpszOwner As String, ByVal Permissions As Integer, ByVal UseStrongEncryption As Integer) As Integer
    Declare Unicode Function DTWAIN_SetPDFKeywordsW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpKeyWords As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFPageScaleStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal nOptions As Integer, ByVal xScale As String, ByVal yScale As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFPageSizeStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal PageSize As Integer, ByVal CustomWidth As String, ByVal CustomHeight As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFProducerW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpProducer As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFSubjectW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpSubject As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFTitleW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal lpTitle As String) As Integer
    Declare Unicode Function DTWAIN_SetPostScriptTitleW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal szTitle As String) As Integer
    Declare Unicode Function DTWAIN_SetPrinterSuffixStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Suffix As String) As Integer
    Declare Unicode Function DTWAIN_SetResolutionStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Resolution As String) As Integer
    Declare Unicode Function DTWAIN_SetRotationStringW Lib "DTWAIN32U.DLL" (ByVal Source As Integer, ByVal Rotation As String) As Integer
    Declare Unicode Function DTWAIN_SetTempFileDirectoryW Lib "DTWAIN32U.DLL" (ByVal szFilePath As String) As Integer
    Declare Unicode Function DTWAIN_SetTwainLogW Lib "DTWAIN32U.DLL" (ByVal LogFlags As Integer, ByVal lpszLogFile As String) As Integer
    Declare Unicode Function DTWAIN_StartTwainSessionW Lib "DTWAIN32U.DLL" (ByVal hWndMsg As IntPtr, ByVal lpszDLLName As String) As Integer
    Declare Unicode Function DTWAIN_SysInitializeEx2W Lib "DTWAIN32U.DLL" (ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Unicode Function DTWAIN_SysInitializeExW Lib "DTWAIN32U.DLL" (ByVal szINIPath As String) As Integer
    Declare Unicode Function DTWAIN_SysInitializeLibEx2W Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String, ByVal szImageDLLPath As String, ByVal szLangResourcePath As String) As Integer
    Declare Unicode Function DTWAIN_SysInitializeLibExW Lib "DTWAIN32U.DLL" (ByVal hInstance As Integer, ByVal szINIPath As String) As Integer
    Declare Unicode Function DTWAIN_TwainSaveW Lib "DTWAIN32U.DLL" (ByVal cmd As String) As Integer
    Declare Unicode Sub DTWAIN_XW Lib "DTWAIN32U.DLL" (ByVal s As String) 
    Declare Auto Function DTWAIN_GetNameFromCap Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetTempFileDirectory Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetErrorString Lib "DTWAIN32U.DLL" (ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetVersionString Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetVersionInfo Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceManufacturer Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceProductFamily Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceProductName Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceVersionInfo Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetOCRErrorString Lib "DTWAIN32U.DLL" (ByVal nEngine As Integer, ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetDSMFullName Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer, ByRef pStatus As Integer) As Integer
    Declare Ansi Function DTWAIN_GetNameFromCapA Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTempFileDirectoryA Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetErrorStringA Lib "DTWAIN32U.DLL" (ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionStringA Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionInfoA Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceManufacturerA Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductFamilyA Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductNameA Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceVersionInfoA Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRErrorStringA Lib "DTWAIN32U.DLL" (ByVal nEngine As Integer, ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetDSMFullNameA Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer, ByRef pStatus As Integer) As Integer
    Declare Unicode Function DTWAIN_GetNameFromCapW Lib "DTWAIN32U.DLL" (ByVal nCapValue As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTempFileDirectoryW Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetErrorStringW Lib "DTWAIN32U.DLL" (ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetVersionStringW Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetVersionInfoW Lib "DTWAIN32U.DLL" (ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceManufacturerW Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceProductFamilyW Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceProductNameW Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceVersionInfoW Lib "DTWAIN32U.DLL" (ByVal nSource As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetOCRErrorStringW Lib "DTWAIN32U.DLL" (ByVal nEngine As Integer, ByVal nError As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetDSMFullNameW Lib "DTWAIN32U.DLL" (ByVal DSMType As Integer, ByVal szValue As System.IntPtr, ByVal nMaxLen As Integer, ByRef pStatus As Integer) As Integer
