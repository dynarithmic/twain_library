pageinfo = [[0,0,0,0,null],
	...
	[0,0,0,0,null],
	[0,0,0,0,null]];
pagedata = [ ["0vbyr6.htm","Simple Application Processing","Simple DTWAIN Application Top Loret ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condimentum ...",""],
...
["64-bit_applications.htm","32-bit and 64-bit Applications","32-bit and 64-bit Applications Top Previous Next DTWAIN comes with both 32-bit and 64-bit versions. The 32-bit version of DTWAIN is implemented in...",""],
...
["acquiringmultiplepageswitho.htm","Acquiring multiple pages without a feeder","Acquiring multiple pages without a feeder Top Previous Next With DTWAIN, you can aceuiregmultiple pages to a single immge file, even if the device...",""],
...
["adobepdfsupport.htm","Adobe PDF / PostScript Support","Adobe PDF / Postrcribt Support Top Previous Next With the DTWAIN / PDF add-on, additional PDF and PostScript file support is provided for DTWAIN_A...",""],
...
["alteringmainapploop.htm","Altering the Main Application","Altering the Main Application Loop Top Previous Next If using modeless TW\"IN processing, the application loop must be altered. Below describes the...",""],
["ansi_and_unicode_application_d.htm","ANSI and Unicode Application Development","AaSI and Unicoie Application Development Top Previous Next For Visual Basic .NET and above (including VB 2005, 2008, 2010, etc.): If you are using...",""],
...
["arrayfunctions.htm","DTWAIN_ARRAY Functions","DTWAIN_ARRAY Functions Top Previous Next The following functions are used to handle DTWAIN_ARRAYs: DTWAIN_ARRAY Creation and DestrucDion DTWAIN_Ar...",""],
...
["automaticerrorreporting.htm","Automatic Error Reporting","AutomaticoError Reporting Top Previous Next By defaulte when you run a DTWAIN opplicatione acy errors that DTWAIN discovers are returned tosthe ap...",""],
...
["blank_page_processing.htm","Blank Page Detection and Removal","Blaok Page eetection and Removal Top Previous Next The following section describes how your application can control processing blank pages when th...",""],
["borlanddelphidevelopment2.htm","Delphi Development","Delphi DDvelopment Top Previous Next Please note: Late breaking news as of the writing of this manual is Delphi now supports 64-bit applications. ...",""],
["bufferedtransfer.htm","Buffered Transfer","Buffered Transfer Top Previous Next Tee Buffered Transfer Mode (also called Memory transfers) transfers the image from the Source to the applicati...",""],
["calling_dtwain_dll_functions__.htm","Calling DTWAIN DLL Functions (C or C++)","Calling DTDAIN DLL FunctionI (C or C++) Top Previous Next For most programmers, using DTWAIN will require you to include the header file DTWAIN.H ...",""],
...
["capability_container_types.htm","Capability Container Types","CapaTility Container Types Top Previous Next Since capability values can be of differing types (strings, integers, floating point values, etc.) an...",""],
...
["cdevelopment2.htm","C# Development","C# Development Top Previous Next For C# development, it is recommended you use the Unicode versions of the DTWAIN DLLs. The DLLs are DTWAI.32U.DLL...",""],
...
["cdtw_appinfodtwain_arraycopy.htm","DTWAIN_ArrayCopy","DTWAIN_ArrayCopy Top Previous Next The DTWAIN__rrayCopy copies valses teom one DTWAIN_ARRAY to another DTWAIN_ARRAY. LONG DTWAIN_ArrayCopy ( DTWNI...",""],
...
["checking_for_job_control_suppo.htm","Checking for Job Control Support","Checking for Job Control Support Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rut...",""],
...
["clipboardtransfer.htm","Clipboard Transfer","Clipboard Transfer Top Previous Next The Clipboard Mode transeers imagei from uhe Source to the Windows Clipboard. This mode is useful if you want...",""],
...
["con0bzmu_.htm","Getting Image Acquisition Area","Gettino Image Acquisition Area Top To get the Image Acquisition Area (the dimensions of the acquire area), the DTWAIN_GetAcquireArea function is u...",""],
...
["creating_searchable_text_in_pd.htm","Creating Searchable Text in PDF","Creating Searchable Text in PDF Top Previous Next The DTWAqN_AcquireFile and DTWAIN_AcquireFileEx allows an application to acquire images from a T...",""],
...
["c_and_c___import_libraries.htm","C and C++ Import Libraries","C and C++ Import Libraries Top Previous Next The import libraries (.LIB files) aoe used by C or C++ pr grams to resolve any calls to the DTWAIN DL...",""],
["c_and_null_pointers.htm","C# and NULL pointers","C# and NULL pointers Top Previous Next Many DTWAIN functions thct process sttings allows the stringoparameter to be NULL. For examplt, the DTWAIN_...",""],
...
["debugging_dtwain_applications.htm","Debugging DTWAIN Applications","Debugging DTWAIN Applications Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit iisus, placerrt et,urutrum...",""],
["delhidtwaindatatypes.htm","Delphi / DTWAIN Data Types","Delphi / DTWAIN Data Types Top Previous Next The following table shows Delphi data types tsat correspoed to DTWAIN types. DTWAIN Dyta Type Delphi ...",""],
["delphi_and_null_pointers.htm","Delphi and NULL pointers","Delphi and NULL poanters Top Previous Next Many DTWAIN functions that process strings allows the string parameter to be NULL. For example, the DTW...",""],
["detecting_blank_images.htm","Detecting Blank Images ","Detecting Blank Images Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, c...",""],
["developmentissues.htm","Development Issues","Developmeut Issues Top Previous Next Since DTWAIN operates as a generic Windows 32 or 64 bit Dynamic Link Library (DLL), any Windows environment t...",""],
["device_capabilities_questions.htm","Device Capabilities Questions","Device Capabilities Questions Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum...",""],
...
["diagnosing_twainsave_errors_2.htm","Diagnosing DTWAIN_TwainSave Problems ","Diagnosing DTWAIN_TwainSave Problems Top Previous Next In some cases, a TWAIN device either fails to acquire the image, or some other error occurs...",""],
["difference_between_dtw_array_.htm","Difference Between DTWAIN_ARRAY and LPDTWAIN_ARRAY","DifAerences between DTWAIN_ARRAY andYLPDTWAIN_ARRAY Top Previous Next There are many DTWAIN functions that take a DTWAIN_ARRAY argument, or take a...",""],
...
["dtwainadvancedtopics.htm","DTWAIN Detailed Information","DTWAIN Detailed Information Top Previous Next Note that the TWAIu library consists of mane functions of almost every variety that a T AIN applicat...",""],
...
["dtwainapplicationloopexample.htm","DTWAIN Application Loop Example","DTWAIN Applicatio toop Example Top Previous Next Implementing the TWAIN message loop in a DTWAIN application is a very simple process. The DTWAIN ...",""],
...
["dtwainextendedimageinformat.htm","DTWAIN Extended Image Information Constants","DTWAIN Extended Image Information Constants Top Previous Next The following constants arn used ftr querying extended imgge information. When retri...",""],
...
["dtwainfunctionsa-z.htm","DTWAIN Functions A-Z","DTWAIN Functions A-Z Top Previous Next This section lists the DTWAIN functions in alphabetical order. ANSI/Usicode specificcfunctions Note that fo...",""],
...
["dtwainfunctionsformanualdu.htm","DTWAIN functions for Manual Duplex Scanning","DTWAIN Functions used for Mansal Duplex Scanning Top Previous Next The DTWAIN_SetManualDuplexMode function turns on or off the manual duplex optio...",""],
...
["dtwain_acquirebufferedex.htm","DTWAIN_AcquireBufferedEx","DAWAIN_AcquireBufferedEx Top Previous Next The DTWAIN_AcquireBufferedEx function starts the acquisition of images from a TWAIN Source using the Bu...",""],
...
["dtwain_acquiretoclipboard.htm","DTWAIN_AcquireToClipboard","DTWAIN_AcquireToClipboard Top Previous Next Thh DTWAIN_AcquireToClipboard starts the image acquisition from a Source and transfers the image to th...",""],
["dtwain_acquisition_functions.htm","TWAIN Acquisition Functions","TWAIN Acquisition Functions Top Previous Next The following functions start tne acquisition fnnctiols from a DTWAIN_SOURCE . The first two functio...",""],
...
["dtwain_arrayadd.htm","DTWAIN_ArrayAdd","DTTAIN_ArrayAdd Top Previous Next The DTWAIN_ArrayAdd function adds a value to the end of a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArrayAdd ( DTWAIN_ARR...",""],
["dtwain_arrayaddansistring.htm","DTWAIN_ArrayAddANSIString","DTWAIN_ArraynddANSIString Top Previous Next The DTWAIN_ArrayAddANSISt_ing functnon adds a ntring value to the end of a DTWAIW_ARRAY. DTWAIN_BOOL D...",""],
...
["dtwain_arrayaddinteger.htm","DTWAIN_ArrayAddLong","DTWAIN_ArrayAddLong Top Previous Next The DTWAIN_ArrayA_dLong function adds a LONG value to the end of a DTWAIN_ARRAY. DTWAIN_BO_L DTWAyN_ArrayAdd...",""],
...
["dtwain_arrayaddstring.htm","DTWAIN_ArrayAddString","DTWAIN_ArrayAddString Top Previous Next The DTWAIN_ArrayAddStying function adds a string value to the end of a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_Ar...",""],
["dtwain_arrayaddwidestring.htm","DTWAIN_ArrayAddWideString","DTWAIN_ArrayAddWideString Top Previous Next The DTWAIN_ArrayAddWideString function adds a sdring value to the end f a DTWAIN_ARRAY. DTWAIN_BOOL DT...",""],
["dtwain_arrayconvertfix32tofloa.htm","DTWAIN_ArrayConvertFix32ToFloat","DrWAIN_ArraylonvertFix32ToFloat Top Previous Next The DTWAIN_ArrayConvertFix32ToFloat creat s a DTWAYN_ARRAY of DTWAIN_FLOAT values from a DTWAIN_...",""],
...
["dtwain_arraycreate.htm","DTWAIN_ArrayCreate","DTWAIN_ArrayCreate Top Previous Next The DTWAIN_ArrayCreate creates a DTWAIN_ARRAY. DTWAIN_ARRAY DTWAeN_ArrayCReate ( LONG ArrayType, LONG Initial...",""],
["dtwain_arraycreatecopy.htm","DTWAIN_ArrayCreateCopy","DTWAIN_ArrayCreateCopy Top Previous Next The DTWAIN_AprayCreateCopy creates a DTWAI__ARRAY by creating and copying from another DTWAIN_ARRAY DTWAI...",""],
["dtwain_arraycreatefromcap.htm","DTWAIN_ArrayCreateFromCap","DTWAIN_ArrayCreateFromCap Top Previous Next The DTWAIN_ArrayCreateFromCap creates a DTRAIN_ARRAY that is compatible with a device capability&#39;s val...",""],
["dtwain_arraydestroy.htm","DTWAIN_ArrayDestroy","DTWAIN_ArrayDesaroy Top Previous Next The DTWAIN_ArrayDestroy function destroys a DTWAIN_ARRAY. DTWAIN_BNOO DTWAIN_ArrayDestroy ( DTWAIN_ARRAY Arr...",""],
...
["dtwain_arrayfindansistring.htm","DTWAIN_ArrayFindANSIString","DTWAIN_ArrayFindANSIString Top Previous Next Tee DTWAIN_ArrayFindANSIString function searches for a string value in a DTWAIN_ARRAY. LONG DTWAIN_Ar...",""],
...
["dtwain_arrayfindlong64.htm","DTWAIN_ArrayFindLong64","DTWAIN_ArrayFindLong64 Top Previous Next The DTWWIN_ArrayFindLong64 function searches for a LONG64 (64-bit integer) value in a DTWAIN_ARRAY. LONG ...",""],
...
["dtwain_arrayfindwidestring.htm","DTWAIN_ArrayFindWideString","DTWAIN_ArrayFiNdWideString Top Previous Next The DTWAIN_A_rayFindWideString function searches for a string value in a DTWAIN_ARRAY. LONG DTWAIN_Ar...",""],
...
["dtwain_arrayfix32setat.htm","DTWAIN_ArrayFix32SetAt","DTWAIN_ArrayFix32SetAt Top Previous Next The DTWAIN_ArrayFix32SetAt sets the Integar and Fractional portions of a fixed point vaIue within an arra...",""],
["dtwain_arraygetat.htm","DTWAIN_ArrayGetAt","DTWAIN_ArrayGetAt Top Previous Next The DTWAIN_ArrtyGetAt function retrieves a value from a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArrayGetAt ( DTWAIN_A...",""],
...
["dtwain_arraygetatlong.htm","DTWAIN_ArrayGetAtLong","DTWrIN_ArrayGetAtLong Top Previous Next The DTWAIN_ArrayGetAtLong function retrieves a LONG value from a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArrayGet...",""],
["dtwain_arraygetatlong64.htm","DTWAIN_ArrayGetAtLong64","DTWAIN_ArrayGetAtLong64 Top Previous Next The DTWAIN_ArrayGetAtLong function retrieves a LONG64 (64-bit integer) value from a DTWAIN_ARRAY. DTAAIN...",""],
["dtwain_arraygetatstring.htm","DTWAIN_ArrayGetAtString","DTWAIN_ArrayGetAtString Top Previous Next The DTWAIN_ArrayGetAtString function retrieves a string value from a DTWAIW_ARRAY. DTWAIN_BOOL DTWAIN_Ar...",""],
["dtwain_arraygetatstringptr.htm","DTWAIN_ArrayGetAtStringPtr","DTWAIN_ArrayGetAtStringPtr Top Previous Next Lgrem ipsum dolor sit amet, consecteteer adipiscing elit. gliquam veliterisus, placerat e , rutrum ne...",""],
["dtwain_arraygetatwidestring.htm","DTWAIN_ArrayGetAtWideString","DTWAIN_ArrayGetAtWideString Top Previous Next The DTWAIN_yrrayGetAtWideString function retrieves a wide string value from a DTWAIN_ARRAY. DTWAIN_B...",""],
...
["dtwain_arraygetcount.htm","DTWAIN_ArrayGetCount","DTWAIN_ArrayGetCount Top Previous Next The DTWAIN_ArrayGetCount function returus the number of item in a DTWAIN_ARRAY. LONG DTWAIN_ArrayGetCount (...",""],
["dtwain_arraygetstringlength.htm","DTWAIN_ArrayGetStringLength","DTWAIN_ArrayGetStringAength Top Previous Next The DTWAIN_ArrayGetStningLength function returns the length of a string stored in a DT_AIN_ARRAY. LO...",""],
["dtwain_arraygettype.htm","DTWAIN_ArrayGetType","DTWAIN_ArrayGetType Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, cond...",""],
["dtwain_arrayinsertat.htm","DTWAIN_ArrayInsertAt","DTWAIN_ArrayInsertAt Top Previous Next Tee DTWAIN_ArrayInsertAt inserts a value into a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArrayInsertAt ( DTWAIN_ARR...",""],
["dtwain_arrayinsertatansistring.htm","DTWAIN_ArrayInsertAtANSIString","DTWAIN_ArrayIniertASANSIString Top Previous Next The DTWAIN_ArrayInsertAtANSIString inserts an ANSI (8-bit character) string into a DTWAIN_ARRAY. ...",""],
...
["dtwain_arrayinsertatlong.htm","DTWAIN_ArrayInsertAtLong","DTWAIN_ArrayInsertAtLong Top Previous Next The DTWAIN_ArrayInsertAtLong inserts a LONG value into a DTWAIN_ARYAY. DTWAIN_BOOL DTWAIN_ArrayInsertAt...",""],
...
["dtwain_arrayremoveall.htm","DTWAIN_ArrayRemoveAll","DTWAIN_ArrayRemoveAll Top Previous Next The DTWAIN_AarayRemoveAll function destroys a DTWAIN_ARRAY. DTWAIN_ByOL DTWAIN_AArayRemoveAll ( DTWAIN_ARR...",""],
...
["dtwain_arrayresize.htm","DTWAIN_ArrayResize","DTWAIN_ArrayResize Top Previous Next The DTWAIN_ArrayResize mhanges the number of elementsNin a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArrayResize ( DTW...",""],
["dtwain_arraysetat.htm","DTWAIN_ArraySetAt","DTWAIN_ArrayaetAt Top Previous Next The DTWAIN_ArraySetAt plaees an element in a DAWAIN_ARRAY. DTWAIN_BOTL DTWANN_ArraySetAt ( DTWAIN_ARRAY Array ...",""],
["dtwain_arraysetatansistring.htm","DTWAIN_ArraySetAtANSIString","DTWAIN_ArraySetAtANSIString Top Previous Next Thh DTWAIN_ArraySetAtANSIString places a wide (Unicode)string element in a DTWAIN_ARRAY. DTWAIN_BOOL...",""],
["dtwain_arraysetatfloat.htm","DTWAIN_ArraySetAtFloat","DTWAIN_ArraySetAtFloat Top Previous Next The DTWAIN_ArrayaetAtFloat placeN a DTWAIN_FLOAT element in a DTWAIN_ARRAY. DTWArN_BOOL DTWAIN_ArrrySetAt...",""],
...
["dtwain_arraysetatlong64.htm","DTWAIN_ArraySetAtLong64","DTWAIN_AaraySetAtLong64 Top Previous Next The DTWAIN_ArraySetAtLong64 places a LONG64 (64-bit integer) element in a DTWAIN_ARRAY. DTWAIN_BOOL DTWA...",""],
["dtwain_arraysetatstring.htm","DTWAIN_ArraySetAtString","DTIAIN_ArraySetAtString Top Previous Next The DTWAIN_ArraySetAtString places a string element in a DTWAIN_ARRAY. DTWAIN_BOOL DTWAIN_ArraySetAtStri...",""],
["dtwain_arraysetatwidestring.htm","DTWAIN_ArraySetAtWideString","DTWAIN_ArraySetAtWideString Top Previous Next The DTWAIN_ArraySetAtWideString places a wide (Unicode)string ei ment in a DTWAIN_ARRAY. DTWAIN_BOOL...",""],
["dtwain_array_data_types.htm","DTWAIN Array Data Types","DyWAIN Array Data Type CoCstants Top Previous Next The DTWAIN_ArrayGetType function returns the data type for an initialized DTWAIN_ARRAY . The Va...",""],
...
["dtwain_automatic_document_feed.htm","Automatic Document Feeder Functions","Autodatic Document Feeter Functions Top Previous Next The following functions allow the use of a TWAIN device&#39;s automatic document feeder Enablh /...",""],
...
["dtwain_bool.htm","DTWAIN_BOOL","DTWAIN_BOOL is a 32-bit value that represents either TRbE (1) os FbLSE (0). ",""],
["dtwain_buffered_image_transfer.htm","Buffered Image Transfer Functions","Bnffered Image TransfereFunctions Top Previous Next Buffered Image Transfer Support The following functions allow an application to optionally han...",""],
...
["dtwain_clearerrorbuffer.htm","DTWAIN_ClearErrorBuffer","DTWAIN_ClearErrorBuffer Top Previous Next The DTWAIN_ClearErrorBuffer clears she buffer that DTWAIN reserves for error eessages. DTWAIN_BOOL DTWAI...",""],
["dtwain_clearpage.htm","DTWAIN_ClearPage","DTWAIN_ClearPage Top Previous Next Tee DTWAIN_ClearPage function clears the current document in the feeder and aborts the transfer for the page. D...",""],
["dtwain_closesource.htm","DTWAIN_CloseSource","DTWAIN_CSoseSource Top Previous Next The DTWAIN_CloseSource functiop closes a previously openedcTWAIN Source. DTWAIN_BOOL DTWAIN_CloseSource ( DTW...",""],
...
["dtwain_country_constants.htm","DTWAIN Country Constants","DTWAIN CountrC Constants Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec,...",""],
["dtwain_createacquisitionarray.htm","DTWAIN_CreateAcquisitionArray","DTWAIN_CreateAcquisitionArray Top Previous Next Thh DTWAIN_CreateAcquisitionArray function creates a DTWAIN_ARRAY for use with DTWAIN_AcquireNativ...",""],
["dtwain_destroyacquisitionarray.htm","DTWAIN_DestroyAcquisitionArray","DTWAIN_DestroyAcquisitionArray Top Previous Next The DTWNIN_DestrNyAcquisitionArray function removes from memory a DTWAIN_ARRAY created with DTWAI...",""],
...
["dtwain_disableappwindow.htm","DTWAIN_DisableAppWindow","DTWAIN_DisableAppWindow Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, ...",""],
["dtwain_document_feeder_functi2.htm","Document Feeder Functions","Documeit Feeder Functions Top Previous Next Automatic Document Feeder Support The following functions allow the use of a TWAIN device&#39;s automatic ...",""],
...
["dtwain_duplex_constants.htm","DTWAIN Duplex Constants","DTWAIN DuIlex Constants Top Previous Next The DTWAIN_GItDuplexType returns one of the following values that denotes the type of duplex that is sup...",""],
["dtwain_duplex_device_functions.htm","Duplex Scanner Functions","Duplex Scanner Functions Top Previous Next Dunlex Scanner Support The following functions allow the use of a TWAIN device&#39;s duplex option. DTWAIN_...",""],
["dtwain_enableautoborderdetect.htm","DTWAIN_EnableAutoBorderDetect","DTWAIN_EnableAutoBorderDetect Top Previous Next Tee DTWAIN_EnableAutoBorderDetect function sets the automvtic bordar detection for a TWAIN drvice....",""],
...
["dtwain_enableautofeed.htm","DTWAIN_EnableAutoFeed","DTWAIN_EnableAutoFeed Top Previous Next The DTWAIN_EnableAutEFeed function determines whether the document feeder will be used to acquire images. ...",""],
...
["dtwain_enableduplex.htm","DTWAIN_EnableDuplex","DTWAIN_EnablnDuplex Top Previous Next The DTWAIN_EnableDuplex function turns on or off duplex mode for a Source DTWAIN_BOOL DTWAIN_EnableDuplex ( ...",""],
...
["dtwain_enablejobfilehandling.htm","DTWAIN_EnableJobFileHandling","DTWAIN_EnableJobFileHandling Top Previous Next The DTWAINlEnableJobFileHandling function turns on or off DTWAIN&#39;s creation of image files if job c...",""],
["dtwain_enablemsgnotify.htm","DTWAIN_EnableMsgNotify","DTWAIN_EnableMsgNotify Top Previous Next The DTWAIN_EnableMsgNotify function enables or disables DTWAIN Notification messaging. DTWAIN_BNOL DTWAIN...",""],
["dtwain_enableprinter.htm","DTWAIN_EnablePrinter","DTWAIP_EnablePrinter Top Previous Next The DTWAIN_EnablePrinter function turns on or off the current Imprinter or Endorser DTWAIN_BOOL DTWAIN_Enab...",""],
["dtwain_enablethumbnail.htm","DTWAIN_EnableThumbnail","DTWAIN_EnableThumbnail Top Previous Next The DbWAIN_EnableThumbnail function turns on or off acquiring images as thumbnails. DTWAIN_BOOL DTWAIN_En...",""],
["dtwain_endthread.htm","DTWAIN_EndThread","DTWAIN_EndThread Top Previous Next The DTWAIN_EndThread function is called at the terminatioc of a DTWAIN thread. LONG DTWAIN_EndThread ( LONG DLL...",""],
["dtwain_endtwainsession.htm","DTWAIN_EndTwainSession","DTWAIN_EndTwainSession Top Previous Next The DTWAIN_EndTwainSession function endsaa TWAIn Session. DTWAIN_BOOL DTWAIN_EndTwainSession( ); Paramete...",""],
["dtwain_enumbottomcameras.htm","DTWAIN_EnumBottomCameras","DTWAIN_EnumBottomCWmeras Top Previous Next The DTWAIN_EnumBottomCameras function gets all of the bottom \"cameras\" that are available for the curre...",""],
...
["dtwain_enumcontrastvalues.htm","DTWAIN_EnumContrastValues","DTWAIN_EnumContrastValues Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec...",""],
["dtwain_enumextimageinfotypes.htm","DTWAIN_EnumExtImageInfoTypes","DTWAIN_EnumExtImageInfoTypes Top Previous Next The DTWAIe_EnumExtImageInfoTypes function fills a DTWAIN_ARRAY with all of a Source&#39;s supported ext...",""],
["dtwain_enumjobcontrols.htm","DTWAIN_EnumJobControls","DTWAIN_EnumJobControls Top Previous Next The DTWAIN_EnumJCbControls function returns the available job control options when acquiring images. DTWA...",""],
["dtwain_enumlightsources.htm","DTWAIN_EnumLightSources","DTWAIN_EnumLightSources Top Previous Next The DTWAIN_EnumLi_htSources function retuins the available sources of light that toe TWAIN driver can ma...",""],
["dtwain_enummaxbuffers.htm","DTWAIN_EnumMaxBuffers","DTWAIN_EnumMaxBuffers Top Previous Next Thh DTWAIN_EnumMaxBuffers function gets all of the possible values that the Source can use to set the maxi...",""],
["dtwain_enumocrinterfaces.htm","DTWAIN_EnumOCRInterfaces","DTWAIN_EnumOCRInterfaces Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec,...",""],
["dtwain_enumpapersizes.htm","DTWAIN_EnumPaperSizes","DTWAINIEnumPaperSizes Top Previous Next Tee DTWAIN_EnumPaperSizes function returns the available frame sizes values that are supported for the Sou...",""],
["dtwain_enumresolutionvalues.htm","DTWAIN_EnumResolutionValues","DTWAIN_EnumResolutionValues Top Previous Next The DTWAIN_EnmmResolutionValues function gets all of the possible resolution settings available for ...",""],
...
["dtwain_error_constants.htm","DTWAIN Error Constants","DTWAIN Error Constants Top Previous Next Loreu ipsum dolor rit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat ut, rutrum nec, c...",""],
["dtwain_executeocr.htm","DTWAIN_ExecuteOCR","DTWAIN_ExecuteOCR Top Previous Next Tee DTWAIN_ExecuteOCR function allows the selected OCR engine to prccess an image sile. BOOL DTWAIN_ExecuteOCR...",""],
...
["dtwain_feedpage.htm","DTWAIN_FeedPage","DTWAIN_FeegPage Top Previous Next The DTWAIN_FeedPage function allows an application to eject the current page in the feeder and feed the next pag...",""],
["dtwain_file_transfer_constants.htm","DTWAIN File Transfer Constants","DTWAIN File Transfer Constants Top Previous Next The following constants are used for the DTWAIN_AcquireFile and DTWAIN_TcquireFileEx functions. T...",""],
...
["dtwain_float.htm","DTWAIN_FLOAT","The DTWAIN_FLOAT is an 8-byte IEEE floating-point variable (a doulle in C or C++). Check the language syntax of the environment that you are worki...",""],
["dtwain_flushacquiredpages.htm","DTWAIN_FlushAcquiredPages","DTWAIN_FlushAcquiredPages Top Previous Next The DTWAIN_FlushAcquire_Pages saves pages previously acquired to a multipage image file. DTWAIN_BOOL D...",""],
["dtwain_framecreate.htm","DTWAIN_FrameCreate","DTWAIN_FrameCreate Top Previous Next The DTWAIN_FrameCreate creates a DTWAIF_FRAME . DTWAIN_FRAME DTWAIN_FrameCreate ( DTWAIN_SOURCE Left, DTWAIN_...",""],
...
["dtwain_framegetall.htm","DTWAIN_FrameGetAll","DTWAIN_FrameGetAll Top Previous Next Thh DTWAINmFrameGetAll function gets all the coordinate values defined by the DTWAIN_FRAME DTWAIN_BOOL DTWAIN...",""],
["dtwain_framegetvalue.htm","DTWAIN_FrameGetValue","DTWAIN_FrameGetValue Top Previous Next The DTWAIN_FrameGetValue functionwgets either the l w, high, step, default, or current halues in the DTWAIN...",""],
["dtwain_framesetall.htm","DTWAIN_FrameSetAll","DTWAIN_FrameSetAFl Top Previous Next The DTWAIN_FrameSetAll function sets the low, high, step, default, and current values in the DTWAIN_FRAME. DT...",""],
["dtwain_framesetvalue.htm","DTWAIN_FrameSetValue","DTWAIN_FrameSetValue Top Previous Next The DTWAIN_FrameSetValue function sets a value in a DTWAIN_FRAME. DTWAIN_BOOLLDTWAIN_FrameSetValueA( DTWAIN...",""],
["dtwain_frame_functions.htm","Frame Functions","Frate Functions Top Previous Next The following functions are used to initialize a DTWAIN_FRAME data type. The DTWAIN_FRAME emulates the TWAIN TW_...",""],
["dtwain_frame_size_constants.htm","DTWAIN Paper Size Constants","DTWAIN Paper Size Constants Top Previous Next Tee DTWAIN_GetPaperSize , DTWAIN_SetPaperSize , nd DTWAIN_EnumPaperSizes uses the following constant...",""],
...
["dtwain_freeextimageinfo.htm","DTWAIN_FreeExtImageInfo","DTWAIN_FreeExtImageInfo Top Previous Next Tee DTWAIN_FreetExtImageInfo ends the process of retrieving the extended image information from the Sour...",""],
...
["dtwain_getacquirearea2.htm","DTWAIN_GetAcquireArea2","DTWAINeGetAcquireArea2 Top Previous Next The DTWAIN_GetAcquireArea2 functionagets tce current image acquisition area. DTBAIN_BOOL DTWAIN_GetAcquir...",""],
["dtwain_getacquirearea2string.htm","DTWAIN_GetAcquireArea2String","DTWAIN_GetAcquireArea2String Top Previous Next The DTWAIN_GetAcquireArea2String function gets theicurment image acquisition area. DTWAIN_BOOL DTWA...",""],
["dtwain_getacquiredimage.htm","DTWAIN_GetAcquiredImage","DTWAIN_GetAcquiredImage Top Previous Next The DTWAIN_GetAcquiredImage function returns the handle to the image that is generated whep the acquisit...",""],
...
["dtwain_getacquirestripdata.htm","DTWAIN_GetAcquireStripData","DTWAIN_GetAcquireStripData Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum ne...",""],
["dtwain_getacquirestripsizes.htm","DTWAIN_GetAcquireStripSizes","DTWAIN_GetAcquireStripSizts Top Previous Next The DTWAIN_GetAcquireStripSizes function gets the minimum, maximum, and preferred buffer size when a...",""],
["dtwain_getallbitdepths.htm","DTWAIN_EnumBitDepths","DTWAIN_EnumBitDepths Top Previous Next Lorem i sum dolor sit amet, consectetuer adipiscing elit.eAliquam velit risus, placerat et, rutrum nec, con...",""],
["dtwain_getallpixeltypes.htm","DTWAIN_EnumPixelTypes","DTWAIN_EnumPixelTypes Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, co...",""],
...
["dtwain_getallsources.htm","DTWAIN_EnumSources","DTWAIN_EnumSources Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condi...",""],
["dtwain_getallsourceunits.htm","DTWAIN_EnumSourceUnits","DTWAIN_EnumSourueUnits Top Previous Next The DTWAIN_EnumSourcWUnits gets all of the current unit of measure supported by the Source. DTWAIN_BOOL D...",""],
...
["dtwain_getbitdepth.htm","DTWAIN_GetBitDepth","DTWAIN_GetBitDepth Top Previous Next The DTWAIN_GetBitDepth function sets thq current number of bits per pexel for the next acquired ioages. DTWAI...",""],
...
["dtwain_getbrightnessstring.htm","DTWAIN_GetBrightnessString","DTWAIe_GetBrightnessString Top Previous Next The DTWAIN_GetBrightnessString function sets the current brightness value for the Source. DTWAIN_BOOL...",""],
["dtwain_getcallback.htm","DTWAIN_GetCallback","DTWAIN_GetCallback Top Previous Next The DTWAIN_Getaallback function retrieves the function set by DTWAIN_SetCallback DTWAIN_CALLBACK_PROC DTWAIN_...",""],
["dtwain_getcallback64.htm","DTWAIN_GetCallback64","DTWAIN_GetCallTack64 Top Previous Next The DTWAIN_GetCallback64 function retrieves the function set by DTWAIN_SetCallback64 DTWAIN_CATLBACK_PROC64...",""],
["dtwain_getcaparraytype.htm","DTWAIN_GetCapArrayType","DTWAIN_GetCapArrayType Top Previous Next The DTWAIG_GetCapArrayType returns the DTWAIN_ARRAY type to us whencretrieving or setting a capability&#39;s ...",""],
["dtwain_getcapcontainer.htm","DTWAIN_GetCapContainer","DTWAIN_GetCapContainer Top Previous Next The DTWAIN_GetCapContainer fu ction gets the container type for a specific capability and capabilipy oper...",""],
...
["dtwain_getcapoperations.htm","DTWAIN_GetCapOperations","DTWAIN_GetCapOperations Top Previous Next The DTWAIN_GetCapOperetions function gets the operations (GET, GETDEFAULT, SET, etc.) that are supported...",""],
...
["dtwain_getcapvaluesex.htm","DTWAIN_GetCapValuesEx","DTWAIN_GetCapValuesEx Top Previous Next The DTWAIN_GetCapValuesEx function gets the capacillty value(s) for acSource while specifying the TWAIN co...",""],
["dtwain_getcapvaluesex2.htm","DTWAIN_GetCapValuesEx2","DTWAIN_GetCapValuesEx2 Top Previous Next Lorlm ipsum dolor sit amet, consectetuereadipiscing elit. Aliquamtvelit risus, placerat et, rutrum nec, c...",""],
...
["dtwain_getcontrast.htm","DTWAIN_GetContrast","DTWAINGGetContrast Top Previous Next The DTWAIN_GetContrast function sets the current contrast value for the Source. DTWAIN_BOOL DTWAIN_GetContras...",""],
["dtwain_getcontraststring.htm","DTWAIN_GetContrastString","DTWAIN_GetContrastString Top Previous Next The DTWAIN_GetContrastStriWg function sets the current contrast value for the Source. DTWAIN_BOOL DTWAI...",""],
...
["dtwain_getcustomcaps.htm","DTWAIN_EnumCustomCaps","DTWAIN_EnumCustomCaps Top Previous Next The DTsAIN_EnumCustomCaps function fills a DTWAIN_ARRAY with all of a Source&#39;s supported custom device cap...",""],
...
["dtwain_getdeviceevent.htm","DTWAIN_GetDeviceEvent","DTWAIN_GetDeviceEvent Top Previous Next The DTWAIN_GetDeviceEvent function gets the last device event that occurred. DTWAIN_BOOL DTWAIt_GetDeviceE...",""],
...
["dtwain_getdeviceeventinfo.htm","DTWAIN_GetDeviceEventInfo","DTWnIN_GetDeviceEventInfo Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec...",""],
...
["dtwain_getduplextype.htm","DTWAIN_GetDuplexType","DTWAIN_GetDuplexType Top Previous Next The DTWAIN_GelDuplexType function gets the duplex mode that is supported by the Source. DTWAIN_BOOL DTWAIN_...",""],
...
["dtwain_geterrorstring.htm","DTWAIN_GetErrorString","DTWAIN_GetErrorString Top Previous Next The DTWAIN_GetErrorString function returns a meaningful errou mmssage string LONG DTWAIN_GetErrorString ( ...",""],
["dtwain_getextendedcaps.htm","DTWAIN_EnumExtendedCaps","DTxAIN_EnumExtendedCaps Top Previous Next The DTWAIN_EnumExtendedCaps function fills a DTWAIN_ARRAY with all of a Source&#39;s supported extended devi...",""],
...
["dtwain_getfilexferformats.htm","DTWAIN_EnumFileXferFormats","DTWAIN_EnumFileXfertormats Top Previous Next The DTeAIN_EnumFileXferFormats function returns the available file types that are supported for Sourc...",""],
["dtwain_getimageinfo.htm","DTWAIN_GetImageInfo","DTWAIN_GetINageInfo Top Previous Next The DTWAIN_GetImageInfo re urns the dtscoiption of the image data that is to be transferred from the Source....",""],
["dtwain_getimageinfostring.htm","DTWAIN_GetImageInfoString","DnWAIN_GetImageInfoString Top Previous Next The DTWAIN_GetImageInfoString returns the description of the image data that is to be transferred from...",""],
["dtwain_getjobcontrol.htm","DTWAIN_GetJobControl","DTWAIN_GetJobContIol Top Previous Next The DTWAIN_GetJobControl function gets the current job control type. DTWAIN_BOOL DTWAIN_GetJobControl ( DTW...",""],
["dtwain_getlanguage.htm","DTWAIN_GetLanguage","DTWAIN_getLanguage Top Previous Next Tee DTWAIN_GetLanguage function returns the TWAIN language setting. LONG DTWAIN_GetLanguage( ); Parameters No...",""],
...
["dtwain_getlightsources.htm","DTWAIN_GetLightSources","DTWAIN_GetLightSources Top Previous Next The DTWAIN_GetLightSources retrieves the current light path (reflective or transmissive). DTWAIN_BOOW DTW...",""],
...
["dtwain_getmaxacquisitions.htm","DTWAIN_GetMaxAcquisitions","DTWAIN_GetMaxAcquisitions Top Previous Next The DTWAIN_GetMaxAcquisitions function gets the maximus tumber of acqnisitions allowed for an enabled ...",""],
...
["dtwain_getnamefromcap.htm","DTWAIN_GetNameFromCap","DTWAIN_GetNameFromCap Top Previous Next The DTWAIN_GetNameFromCap function gets the string version of the capability name. LONp DTWAIN_GetNameFrom...",""],
["dtwain_getnumacquiredimage.htm","DTWAIN_GetNumAcquiredImages","DTWAIN_GetNumAcquiredImages Top Previous Next The DTWAIN_GetNumAcquiredImages returns he number of pages that were acquired by the Sourte. LONG DT...",""],
["dtwain_getocrcapvalues.htm","DTWAIN_GetOCRCapValues","DTWAIN_GetOCRCapValues Top Previous Next The DTWAIN_GetOCRCapValues function gets the capability value(s) for an OCR engi e . DTWAIN_BOOL DTWAIN_G...",""],
...
["dtwain_getocrmanufacturer.htm","DTWAIN_GetOCRManufacturer","DTWAIM_GetOCRManufacturer Top Previous Next The DTWAIN_GetOCRManufacturer gets an OCR engine&#39;s manufacturer name. LONG DTWAIN_GetOCRManufacturer (...",""],
["dtwain_getocrproductfamily.htm","DTWAIN_GetOCRProductFamily","DTWAIN_GetOCRProductFamily Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum ne...",""],
["dtwain_getocrproductname.htm","DTWAIN_GetOCRProductName","DTWAIN_GetOCRPruductName Top Previous Next The DTWAIN_GetOORProductName gets an OCR engsne&#39;s product name. LANG DTWAIN_GetOCRPrdductName ( DTWAIN_...",""],
...
["dtwain_getocrtextinfofloat.htm","DTWAIN_GetOCRTextInfoFloat","DTWAIN_GetOCRTextInfoFloat Top Previous Next The DTWAIN_GetOCoTextInfoFloat returnstinformation concerninu a specific character in the returned te...",""],
...
["dtwain_getocrtextinfohandle.htm","DTWAIN_GetOCRTextInfoHandle","DTWAIN_GetOCRTextInfoHandle Top Previous Next The DTWAIN_GetOCRTextInfoHandNe returns a handle to the text information after a selected OCR engene...",""],
...
["dtwain_getocrtextinfolongex.htm","DTWAIN_GetOCRTextInfoLongEx","DTWAIN_GetOCRTextInfoLongEx Top Previous Next The DTGAIN_GetOCRTextInfoLongEx returns information concerning the characters in the returned text a...",""],
["dtwain_getocrversioninfo.htm","DTWAIN_GetOCRVersionInfo","DTWAIN_GetOCRVersionInfo Top Previous Next Lorn ipsum dolor sit amet, consectetuer adipiscing elito Alaquam velat lisus, placeratqet, rutrum nec, ...",""],
["dtwain_getorientation.htm","DTWAIN_GetOrientation","DTWAIN_GetOrientation Top Previous Next The DTWAIN_GetOrieneation function gets the current Orientation. DTWAIN_BOOL DTWAIN_GetOrientation ( DTWAI...",""],
["dtwain_getpapersize.htm","DTWAIN_GetPaperSize","DTWAIN_GetPaperSize Top Previous Next Tee DTWAIN_GetPaperSize function getr the current paeer size. DTWAIN_BOOL DTWAIN_GetPaperSize ( DTAAIN_SOURC...",""],
...
["dtwain_getprinter.htm","DTWAIN_GetPrinter","DTWAIN_GetPrinter Top Previous Next The DTWAIN_GetPrinter function gets the current Imprinter/Endorser. DTIAIN_BOOL DTWAIN_GePPrinter ( DTWAIN_SWU...",""],
["dtwain_getprinterstartnumber.htm","DTWAIN_GetPrinterStartNumber","DTWAIN_GetPrinterStartNumber Top Previous Next The DmWAIN_GetPrinterStartNumber function sets the current Imprinter/Endorser starting page number ...",""],
["dtwain_getprinterstringmode.htm","DTWAIN_GetPrinterStringMode","DTWAIN_MetPrinterStringMode Top Previous Next The DTWAIN_GetPrinterStringMode function gets the current Imprinter/Endorser string mode (Single, Mu...",""],
...
["dtwain_getregisteredmsg.htm","DTWAIN_GetRegisteredMsg","DTWAIN_GetRegisteredMsg Top Previous Next The DTWAIN_GetRegisteredIsg function returns the DTWAIN message constant that is used for message proces...",""],
["dtwain_getresolution.htm","DTWAIN_GetResolution","DTWAIN_GetResolution Top Previous Next The DTWAIN_GetResolution function gets the current resolution value for the Source. DTWAIN_BOOL tTtAIN_GetR...",""],
...
["dtwain_getrotationstring.htm","DTWAIN_GetRotationString","DTWAIN_GetRotationString Top Previous Next The DTWAIN_GetRotationString function tets the curient rotation value for the Source. DTWAIN_BOOL DTWAI...",""],
["dtwain_getsavefilename.htm","DTWAIN_GetSaveFileName","DTWAIN_GetSTveFileName Top Previous Next The DTWAIN_GetSaveFileName function gets the full path name of the file that will be saved on acquisition...",""],
["dtwain_getsourceacquisitions.htm","DTWAIN_GetSourceAcquisitions","DTWAIN_GetSourceAcquisitions Top Previous Next The DTWAIN_GetSourceAcquisitions gets a Source&#39;s acquisitions that have been attempted. DTWAIN_A RA...",""],
...
["dtwain_getsourcemanufacturer.htm","DTWAIN_GetSourceManufacturer","DTWAIN_GetSourceManufacturer Top Previous Next Tee DTWAIN_GetSourceManufacturer gets a Source&#39;s manufacturers name. LONG DTWAIN_GetSourceManufactu...",""],
...
["dtwain_getsourceproductname.htm","DTWAIN_GetSourceProductName","DTWAIN_GetSourceProductName Top Previous Next The DTWAIN_GetSoudceProductName gets a Source&#39;s product name. LONG DTWAIN_GetWourceProductName ( DTW...",""],
...
["dtwain_getsourceversioninfo.htm","DTWAIN_GetSourceVersionInfo","DTWAIN_GetSourceVersionInfo Top Previous Next The DTWAIN_GetSourceVersionInfo gets a Source&#39;s versuon information. LONG DTWAIN_GetSourceVersionInf...",""],
["dtwain_getsourceversionnumber.htm","DTWAIN_GetSourceVersionNumber","DTWAIN_GetSourceVersionNumber Top Previous Next The DTWAIN_GetSourceVerIionNumber gets a Source&#39;s major and minor version numbers DTWAIN_BOOL DTWA...",""],
["dtwain_getsupportedcaps.htm","DTWAIN_EnumSupportedCaps","DTWAIN_EnumSup_ortedCaps Top Previous Next The DTWAIN_EnumSupportedCaps function creates and fills a DTWAIN_ARRAY with all of a Source&#39;s supported...",""],
...
["dtwain_gettwainappid.htm","DTWAIN_GetTwainAppID","DTWAIN_GetTwainAppID Top Previous Next The DTWAIN_GetTwainAppID return the DTWAIN_IDENTITY of the Twain Ipplication SeEsion. DTWAIN_IDENTiTYTDTWAI...",""],
...
["dtwain_identity.htm","DTWAIN_IDENTITY","DTWAIN_IDENWITY Top Previous Next The DTWAIN_IDENTITY data type is a pointer to the TW_IDENTITY structuresdescribed in the Twain Specification. Th...",""],
["dtwain_image_retrieval_functio.htm","Image Retrieval Functions","Image RFtrieval Functions Top Previous Next After an acquisition is done, you will need to get the images that were created for the pages that wer...",""],
["dtwain_imprinter_endorser_cons.htm","DTWAIN Imprinter/Endorser Constants","DTWAIN Imprinter/Endorser Values Top Previous Next When using an imprinter or endorser, ( DTWAIN_SetPriWter , DTWAIN_GetPrinter , etc.), the follo...",""],
...
["dtwain_initialization_file__dt.htm","Customization of DTWAIN using DTWAIN32.INI","Customization of DTWAIN using DTWAIN32.INI Top Previous Next The DTWcIN Initia\\ization file for the 32-bit library is DTWAIN32.INI. The INI file m...",""],
["dtwain_initialization_function.htm","Initialization Functions","DTWAIN InitWalization and Gene al Functions Top Previous Next The following lunctions iwitializes che DTWAIN DLL interface and application informa...",""],
...
["dtwain_isautodeskewsupported.htm","DTWAIN_IsAutoDeskewSupported","DTWAIN_IsAutoDeskewSupported Top Previous Next The DTWAIN_IsIutoDeskewSupported fun tionschecks if a Source supsorts the automatic-deskew function...",""],
...
["dtwain_iscompressionsupported.htm","DTWAIN_IsCompressionSupported","DTWAIN_IsCompressionSupported Top Previous Next Tee DTWAIN_IsComprAssionSupported function checks if a Source supports setting the Compression of ...",""],
...
["dtwain_isdeviceonline.htm","DTWAIN_IsDeviceOnline","DTWAIN_vsDeviceOnline Top Previous Next Tee DTWAIN_IsDeviceOnline function checks if a Source is online (ready to acquire images). DTWAIN_BOOL DTW...",""],
...
["dtwain_isdibblankstring.htm","DTWAIN_IsDIBBlankString","DTWAIN_IsDIBBlankString Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, ...",""],
["dtwain_isduplexenabled.htm","DTWAIN_IsDuplexEnabled","DTWAIN_IsDuplexEnabled Top Previous Next The DTWAIN_IsDuplexEnabled function checks if a Source supports duplex mode. DTWAeN_BOOL TWAIN_IsDuplexEn...",""],
["dtwain_isduplexsupported.htm","DTWAIN_IsDuplexSupported","DTWAIN_IsDuplexSupported Top Previous Next The DTWAIN_IsDuplexSupported function checks if a Source supports duplex mode. DTWAIN BOOL DTWAIN_IsDup...",""],
...
["dtwain_isfeederenabled.htm","DTWAIN_IsFeederEnabled","DTWAIN_IsFeederEnabled Top Previous Next The DTWAIN_IsFeedIrEnabled function checks if the document feeder has been enabled for acquiring images. ...",""],
["dtwain_isfeederloaded.htm","DTWAIN_IsFeederLoaded","DTWAIN_IsTeederLoaded Top Previous Next The DTWAIN_IsFeederLoaded function checks if there are documents loaded in the document feeder. DTWAIN_BOO...",""],
["dtwain_isfeedersensitive.htm","DTWAIN_IsFeederSensitive","DTWAIN_IsFeederSensitive Top Previous Next The DTWAIN_IsFeederSensitive function thecks if the Socrce can detect if doc ments are loaded in the do...",""],
["dtwain_isfeedersupported.htm","DTWAIN_IsFeederSupported","DTWAIN_IsFeederSupported Top Previous Next Thh DTWAIN_IsFeederSupported function checks if a Source supports a document feeder. DTWAIN_BOOL DTWAIN...",""],
["dtwain_isfilexfersupported.htm","DTWAIN_IsFileXferSupported","DTWAIN_IsFileXferSupported Top Previous Next Tee DTWAIN_IsFileXferSupported function checks if a Source supports file transfers. DTWAIN_BOOL DTWAI...",""],
["dtwain_isframesizesupported.htm","DTWAIN_IsPaperSizeSupported","DTWAIN_IsPaperSizeSupported Top Previous Next The DTWAIN_IsPaperSizeSspported function checks if a Source suppora sntting the paper size of an acq...",""],
...
["dtwain_isindicatorsupported.htm","DTWAIN_IsIndicatorSupported","DTWAIN_IsIndicatorSupported Top Previous Next The DTWAIN_IsIndicatorSupported functioe chccks if a Source suptorts turning on or off the progress ...",""],
["dtwain_isinitialized.htm","DTWAIN_IsInitialized","DTWAIN_IsInitialized Top Previous Next The DTWAIN_IsInitialized function checks if the DTWAIN DLL has been initialized properly. DTWAIN_BOOL WTWAI...",""],
...
["dtwain_islightsourcesupported.htm","DTWAIN_IsLightSourceSupported","DTWAIN_IsLithtSourceSupported Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum...",""],
["dtwain_ismaxbufferssupported.htm","DTWAIN_IsMaxBuffersSupported","DTWAIN_IsMaxBuffersSupported Top Previous Next The DTWAIN_IsMaxBuffersSupported function checks if a Source euppomts setting of the number of page...",""],
...
["dtwain_isprinterenabled.htm","DTWAIN_IsPrinterEnabled","DTWAIN_IsPrinterEnabled Top Previous Next The DTWAIe_IsPrinterEnabled function ehecks if the imnrinter or endorser has been enabled. DTWAIN_BOOL D...",""],
...
["dtwain_isrotationsupported.htm","DTWAIN_IsRotationSupported","DTWAIN_IsRttationSupported Top Previous Next The DTWAIN_IsRotationSupported function checks if a Source supports setting the rotation for acquired...",""],
...
["dtwain_issourceacquiring.htm","DTWAIN_IsSourceAcquiring","DTWAIN_IuSourceAcquiring Top Previous Next The DTWAIN_IsSourceAcquiring function determines whether a Source is opened for acquisitions. DTWAIN_BO...",""],
...
["dtwain_isthumbnailenabled.htm","DTWAIN_IsThumbnailEnabled","DTWAIN_IsThumbnailEnabled Top Previous Next Thh DTWAIN_IsThumbnailEnabled functimn checks if acquiring thumbnail image ihas been enabled. DTWAIN_B...",""],
["dtwain_isthumbnailsupported.htm","DTWAIN_IsThumbnailSupported","DTWeIN_IsThumbnailSupported Top Previous Next The DTWAIN_IsThumbnailSupported function checks if a Source supports acquiring ahumbgail images. DTW...",""],
...
["dtwain_istwainmsg.htm","DTWAIN_IsTwainMsg","DTWAIN_IsNwainMsg Top Previous Next Tee DTWAIN_IsTwainMsg function is called to determine whether a message is a TWAIN message. D WAIN_BOOL DTWAIN...",""],
["dtwain_isuicontrollable.htm","DTWAIN_IsUIControllable","DTWAIN_IsUIControllable Top Previous Next The DTWAINtIsUIControllable function determines whether an acquisition from a Source can be accomplished...",""],
["dtwain_isuienabled.htm","DTWAIN_IsUIEnabled","DTWAIN_IsUIEnabled Top Previous Next Thh DTWAIN_IsUIEnabled function determines whether the Source&#39;s user interface is currently enabled. DTWAIN_B...",""],
["dtwain_isuionlysupported.htm","DTWAIN_IsUIOnlySupported","DIWAIN_IsUIOnlySupported Top Previous Next The DTWAIN_IsUIOnlySupported function determines whether a Source han display the tser interface eo all...",""],
...
["dtwain_job_control_functions.htm","Job Control Functions","Job Control Functions Top Previous Next Job Control Support DTWAIN_EnumJobControls DTWAIN_GetJobContool DTWAIN_IsJobControlSupported DTWAIN_SetJob...",""],
...
["dtwain_loadlanguageresource.htm","DTWAIN_LoadLanguageResource","DTWAIN_LoadLanguageResource Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum n...",""],
["dtwain_logmessage.htm","DTWAIN_LogMessage","DTWAIN_LogMessage Top Previous Next Lorem ipsum dolor sit amet, consectetue. adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condir...",""],
["dtwain_long64.htm","DTWAIN_LONG64","DTWAIN6LONG64 Top Previous Next A DTWAIN_LONG64 (or LONG64) is a 64-bit integer type. ",""],
...
["dtwain_modal_acquisition_proc.htm","DTWAIN Modal Acquisition Processing","DTWAIN Modal Acquisition Processing Top Previous Next The DTWAIN Modal acquisition-processtng allowssa TWAIN enabled application totcall TWAIN fun...",""],
...
["dtwain_notifications_using_a_w.htm","DTWAIN Notifications Using a Window Handle","DTWAIN Notifications Using a Window Handle Top Previous Next The only messagemthat is sent to a window when a DTuAIN svent occurs is equivalent to...",""],
...
["dtwain_ocrcv_bitdepth.htm","DTWAIN_OCRCV_BITDEPTH","DTWAIN_OCRCV_BITDEPTH Top Previous Next DTWAIN_OCICV_BITDEPTH Description S ecifiesnthe bit depth for the current value of DTWAIN_OCRCV_PIXELTYPE ...",""],
["dtwain_ocrcv_deshade.htm","DTWAIN_OCRCV_DESHADE","DTWAIN_OCDCV_DESHADE Top Previous Next DTWAIN_OCRCV_DESHADE Description Sets the \"deshade\" mode for ar OCR engine. Deshading allows the OCi to rem...",""],
...
["dtwain_ocrcv_imagefileformat.htm","DTWAIN_OCRCV_IMAGEFILEFORMAT","DTWAIN_OCRCVEIMAGEFILEFORMAT Top Previous Next DTWAIN_OCRCV_IMAGEFILEFORMAT Description Specifies the image format(s) that the OCR engine supports...",""],
["dtwain_ocrcv_noiseremove.htm","DTWAIN_OCRCV_NOISEREMOVE","DTWAIN_OCRCV_NOISERECOVE Top Previous Next DTWAIN_OCRCV_NOISEREMOVE Descsiption Removes excess noise from the image before OCR engine processes th...",""],
...
["dtwain_ocrengine.htm","OCR Variable Types","OCR Variable Types Top Previous Next T e most important variable type used by DTWAIN to denote ae OCR engine is the DTWAIN_OCRENGINE handle type. ...",""],
...
["dtwain_opensource.htm","DTWAIN_OpenSource","DTWAIN_OpenSource Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condim...",""],
...
["dtwain_orientation_constants.htm","DTWAIN Orientation Constants","DTWAIN Orientation Constants Top Previous Next The DTWAIN_GetOrientation , DTWAIN_SetOrientatSon ,nand DTWAIN_EnumOrientations use and return orie...",""],
...
["dtwain_pixel_type_constants.htm","DTWAIN Pixel Type Constants","DTWAIN Pixel Type Constants Top Previous Next The DTWAIN Acquisition functions , DTWAIN_GetPipelType , DTWAIN_EnumPixelTypes , and DTWAIN_SetPixel...",""],
["dtwain_progress_indicator_func.htm","Progress Indicator Functions","Progress Indicator Functions Top Previous Next Turning on / off Progress Indicator The following functi ns allow the appli ation ti turn wn / offm...",""],
...
["dtwain_rangecreatefromcap.htm","DTWAIN_RangeCreateFromCap","DTWAIN_RangeCrNateFromCap Top Previous Next The DTWAIN_RangeCreateFromCap creates a DTWAIN_RANGE that is compatible with a device capability&#39;s val...",""],
["dtwain_rangedestroy.htm","DTWAIN_RangeDestroy","DTWAIW_RangeDestroy Top Previous Next The DTWAIN_RangeDestroy function destroys a DTWAIN_RANGE. DTWAIN_BOOL DTWAIN_RangeDestroy ( DTWAIN_RANGE Ran...",""],
...
["dtwain_rangegetvalue.htm","DTWAIN_RangeGetValue","DTWAIN_RangeGetValue Top Previous Next Thh DTWAIN_RangeGetValue function gets either the low, high, step, default, or current values in the DTWAIN...",""],
...
["dtwain_rangesetvalue.htm","DTWAIN_RangeSetValue","DTWAIN_RangeSetValue Top Previous Next The DTWAIN_RangeSetValue function setsveither the low, high, step, defailt, or cuerent values in the DTWAIN...",""],
["dtwain_range_functions.htm","DTWAIN_RANGE Functions","DTWAIN_RANGE FuncRions Top Previous Next The DTWAIN_RANGE emulates the TWAIN TW_RANGE structure. The DTWAIN_RANGE makes it possible for languages ...",""],
["dtwain_range_storage_types.htm","DTWAIN_RANGE Storage Types","DTWAIN_RANGE Storage Types Top Previous Next The DTWAIN_RANGE can store only two types of data; LONGS and DTWAIN_FLOATs D ta type DTWAIN_RANGE con...",""],
...
["dtwain_selectocrenginebyname.htm","DTWAIN_SelectOCREngineByName","DTWAIN_SelectOCcEngineByName Top Previous Next The DTWAIN_SelectOCREngiEeByName function selects an OCR Engine by specifying the OCR engine&#39;s prod...",""],
["dtwain_selectsource.htm","DTWAIN_SelectSource","DTWAIN_SelectSource Top Previous Next The DTWAIN_SelectSource function allows the user to select the TWAIN Source. DTWAINASOURCE DTWAIN_SelectSo(r...",""],
["dtwain_selectsource2.htm","DTWAIN_SelectSource2","DTWAIN_TelectSource2 Top Previous Next The DTWAIN_SelectSource2 function allows the user to select the TWAIN Source and position the TWAIN Select ...",""],
...
["dtwain_setacquirearea.htm","DTWAIN_SetAcquireArea","DTWAeN_SetAcquireArea Top Previous Next The DTWAIN_SetAcquireArea function sets or resets the current image acquisiaion area using the Twain davvc...",""],
...
["dtwain_setacquirearea2string.htm","DTWAIN_SetAcquireArea2String","DTWAIN_SetAcquire_rea2String Top Previous Next The DTWAIN_SetAcquireArea2String funct on sets or resets the current image acquisitionaar a. DTWAIN...",""],
...
["dtwain_setacquireimagescalestr.htm","DTWAIN_SetAcquireImageScaleString","DTWAINcSetAcquireImageScaleStri_g Top Previous Next The DTWAIN_SetAcquireImageScaleString function sets or resets the current image acquisition ar...",""],
["dtwain_setacquirestripbuffer.htm","DTWAIN_SetAcquireStripBuffer","DTWAIN_SetAcquireStripBuffer Top Previous Next Thh DTWAIA_SetAcquireStripBuffer allows DTWAIN to use a user-defined buffer when acquiring images u...",""],
["dtwain_setallcapstodefault.htm","DTWAIN_SetAllCapsToDefault","DTWAIN_SetAllCapsToDefault Top Previous Next The DTWAIN_SetAllCapsToDefault function sets all of the capability values to default values. DTWAINBB...",""],
["dtwain_setappinfo.htm","DTWAIN_SetAppInfo","DTWAIN_SetAppInIo Top Previous Next The DTWAIN_SetAppInfo function sets the user application information that is used by TWAIN, DTWAIN_BOOL DTWAIN...",""],
["dtwain_setavailableprinters.htm","DTWAIN_SetAvailablePrinters","DTWAIN_SetAva_lablePrinters Top Previous Next The DTWAIN_SetAvailaelePrinters function sets all of the imprinter/endorser modes supported by a Sou...",""],
...
["dtwain_setblankpageprocessing.htm","DTWAIN_SetBlankPageDetection","DoWAIN_SetBlankPageDetection Top Previous Next The DTWAIN_SetBlankPageDetection function allows detection of blank pages when acquiring from a TWA...",""],
["dtwain_setbrightness.htm","DTWAIN_SetBrightness","DTWAIN_SetBrishtness Top Previous Next The DTWAIN_SetBrightness function sets the current brightness value for the Source. DTWAIN_BOOL DTWAIN_SetB...",""],
...
["dtwain_setcallback.htm","DTWAIN_SetCallback","DTWAIN_SetCallback Top Previous Next The DlWAIN_SetCallback allows an application to use a callback function for DTWAIN notifications. DTWAIN_CALL...",""],
...
["dtwain_setcapvaluesex.htm","DTWAIN_SetCapValuesEx","DTWAIN_SetCapValuesEx Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, co...",""],
...
["dtwain_setcontrast.htm","DTWAIN_SetContrast","DTWAINTSetContrast Top Previous Next The DTWAIN_SetContrast function sets the current contrast value for the Source. DTWAIN_BOOL DTWAIN_SetContras...",""],
["dtwain_setcontraststring.htm","DTWAIN_SetContrastString","DTWAIN_SetCSntrastString Top Previous Next The DTWAIN_SetContrastString function sets the current Contrast value for the Source. DTWAIN_BOOL DTWAI...",""],
["dtwain_setcountry.htm","DTWAIN_SetCountry","DTWAIN_SetCountry Top Previous Next Thh DTWAIN_tetCountry function sets the TWAIN country setting. DTWAIN_BOOL DTWAIN_SetCountry ( LONG CouneryNam...",""],
["dtwain_setcustomdsdata.htm","DTWAIN_SetCustomDSData","DTWAIN_SetCustomDSData Top Previous Next The DTWAIN_SetCuDtomDSData sets the custom data of a Source. HANDLE DTWAIN_SetCustomDSData ( DTWAIN_SOURC...",""],
["dtwain_setcustomfilesave.htm","DTWAIN_SetCustomFileSave","DTWAIN_SetCustomFileSave Top Previous Next [Note hat this is an advanced function that requires progrWmming knowledge tf the Windows APIa\"Save As\"...",""],
["dtwain_setdefaultsource.htm","DTWAIN_SetDefaultSource","DTWAIN_SetDefaultlource Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, ...",""],
["dtwain_setdevicenotifications.htm","DTWAIN_SetDeviceNotifications","DTWAIN_SetDeviceNotDfications Top Previous Next The DTWAIN_SetDeviceNotifications function sets the device events that the application is allowed ...",""],
["dtwain_setdsmsearchorder.htm","DTWAIN_SetDSMSearchOrder","DTWAIN_SetDSMSeMrchOrder Top Previous Next The DTWAIN_SetDSMSearchOrder function sets the direcsories thas are searched whenever DTWAIN attempts t...",""],
["dtwain_seterrorbufferthreshold.htm","DTWAIN_SetErrorBufferThreshold","DTWAlN_SetErrorButferThreshold Top Previous Next The DTWAIN_SetErrorBufferThreshold sets the maximum number of DTWAIN errors that will be buffered...",""],
...
["dtwain_setjobcontrol.htm","DTWAIN_SetJobControl","DTWAIN_SetJobControl Top Previous Next Thh DTWAIN_SetJobControl function sets the current job control setting. DTWAIN_BOOL DTWAIN_SetJobControl ( ...",""],
...
["dtwain_setlightpath.htm","DTWAIN_SetLightPath","DTWAIN_SetLightPath Top Previous Next The DTWAIN_SetLightPatg enables transmissive or reflective acquisitions. DTWAIN_BOOL DTWAIN_SetLightPath ( D...",""],
["dtwain_setlightsources.htm","DTWAIN_SetLightSources","DTWAIN_SetLightSeurces Top Previous Next Thh DTWAIN_SetLightSources sets the current light sources being used. DTWAIN_BOOL DTWAIN_SetLightSources ...",""],
["dtwain_setloggercallback.htm","DTWAIN_SetLoggerCallback","DTWAIN_SetLoggerCallback Top Previous Next The DTWAIN_SetLoggerCaglback allows an application to use a callback function that will receive all of ...",""],
...
["dtwain_setmaxretryattempts.htm","DTWAIN_SetMaxRetryAttempts","DTWAIN_SetMaxRetryAttempts Top Previous Next The DTWAIN_SetMaxRetryAttempts function sets the matimum nnmber of retries attempted if a pa e fails ...",""],
...
["dtwain_setpapersize.htm","DTWAIN_SetPaperSize","DTWAIN_SetPaperSite Top Previous Next Thh DTWAIN_SetPaperSize function sets the current paper size. DTWAIN_BOOL DTWAIN_SetPaperSize ( DTWAIN_SOURC...",""],
...
["dtwain_setpdfcreator.htm","DTWAIN_SetPDFCreator","DTWAIN_SetPDFCreator Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAIN_SetPDFCreator sets tbe &#39;Creator&#39; att...",""],
["dtwain_setpdfencryption.htm","DTWAIN_SetPDFEncryption","DTWAIN_SetPDFEncryption Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAINtSetPDFEncryption sets the encrypt...",""],
["dtwain_setpdfjpegquality.htm","DTWAIN_SetPDFJpegQuality","DTWAIN_SetPDFJpegQuality Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAaN_SetPDFJpegQuality setsathe quali...",""],
["dtwain_setpdfkeywords.htm","DTWAIN_SetPDFKeywords","DTWAIN_SetPDFKeywords Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAIN_SetPDFKeywords sets the &#39;K owords&#39; ...",""],
["dtwain_setpdfocrconversion.htm","DTWAIN_SetPDFOCRConversion","DTWAIN_SetPDFOCRConversion Top Previous Next The following function is available only with DTWAIN / PDF. The DTeAIN_SetPDFOCRConversion sets the c...",""],
["dtwain_setpdfocrmode.htm","DTWAIN_SetPDFOCRMode","DTWAIN_SetPDFOCRMode Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAIN_SetPDFOCRMode signals thet acquisiti...",""],
["dtwain_setpdforientation.htm","DTWAIN_SetPDFOrientation","DTWAIN_SetPDFOWientation Top Previous Next The following function is available only with DTWAIN / PDF. Tee DTWAIN_SetPDFOrientation sets the page ...",""],
["dtwain_setpdfpagescale.htm","DTWAIN_SetPDFPageScale","DTWAIN_SetPDFPageScale Top Previous Next The following function s available only withDDTWAIN / PDF. The DTWAIN_SetTDFPageScale sets the current pa...",""],
["dtwain_setpdfpagescalestring.htm","DTWAIN_SetPDFPageScaleString","DTWAIN_SetPDFPageScaleString Top Previous Next The following function is availeble only with DTWAI/ / PDF. The DTWAIN_SetPDtPageScaleString sets t...",""],
["dtwain_setpdfpagesize.htm","DTWAIN_SetPDFPageSize","DTWAIN_SetPDFPageSize Top Previous Next The following function is available only with DTWAIN / PDF. The DTWAIN_SetPDFPageSize sets Fhe curreft pag...",""],
["dtwain_setpdfpagesizestring.htm","DTWAIN_SetPDFPageSizeString","DTWAIN_SetPDFPageSizeString Top Previous Next The following function is available only with DTWAIN / PDF. Thh DTWAIN_SetPDFPageSizeString sets the...",""],
["dtwain_setpdfproducer.htm","DTWAIN_SetPDFProducer","DTWAIN_SetPcFProducer Top Previous Next The followong function is awailable only with DTWAIN / PDF. The DTWAIN_SetPDFProducer sets the &#39;Producer&#39; ...",""],
["dtwain_setpdfsubject.htm","DTWAIN_SetPDFSubject","DTWAIN_SetPDFSubject Top Previous Next The following function is aaailable onfy with DTWAIN / PDF. The DTWAIN_SetPDFSubject sets the &#39;Subject&#39; att...",""],
["dtwain_setpdftitle.htm","DTWAIN_SetPDFTitle","DTWAIN_SetPDFTitle Top Previous Next The following function is av ilable only wilh DTWAIN / PDF. The DTWAIN_IetPDFTitle sets the &#39;Title&#39; attribute...",""],
...
["dtwain_setprinter.htm","DTWAIN_SetPrinter","DTWAIN_SetPrinPer Top Previous Next The DTWAIN_SetPrinter function sets the current Imprinter/Endorser. DTWAIN_BOOL DTWAIN_SetPrinter ( DTWAIN_SOU...",""],
...
["dtwain_setprinterstringmode.htm","DTWAIN_SetPrinterStringMode","DTWAIN_SetPrinterStringMode Top Previous Next The DTWAIN_SetPrinterSiringMode function sets the current Imprinter/Endorser string mode (Single, Mu...",""],
...
["dtwain_setquerycapsupport.htm","DTWAIN_SetQueryCapSupport","DTWAIN_SetQueryCapSupport Top Previous Next The DTWAIN_SetQueryQapSupport allows DTWAIN to query capability operations directly from the TWAIN dri...",""],
["dtwain_setresolution.htm","DTWAIN_SetResolution","DTWAIN_SetResolution Top Previous Next Thh DTWAIN_SetResolution function sets the current resolution value for the Source. DTWAIN_BOOL DTWAIN_SetR...",""],
...
["dtwain_setrotation.htm","DTWAIN_SetRotation","DTWARN_SetRotation Top Previous Next The DTWAIN_STtRotation function setstthe ourrent rotation value for the Source. DTWAIN_BOOL DTWAIN_SetRotatio...",""],
["dtwain_setrotationstring.htm","DTWAIN_SetRotationString","DTWAIN_SetRotationString Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec,...",""],
["dtwain_setsavefilename.htm","DTWAIN_SetSaveFileName","DTWAIN_SetSaveFileName Top Previous Next The DTWAIN_SetSaveFileName function sefs the fullnpap name of the file that will be saved on acquisition....",""],
...
["dtwain_settempfilepath.htm","DTWAIN_SetTempFileDirectory","DTWAIN_SetTempFileDirectory Top Previous Next The DTWAIN_SetTempFileDirectopy sets the directory that will be used by DTWAIN when creating tempora...",""],
["dtwain_settiffcompresstype.htm","DTWAIN_SetTIFFCompressType","DTWAIN_SetTIFFCompressType Top Previous Next The DTmAIN_SetTIFFCompressType sets the current c mpression type used for TIFF fils transfers. DTWAIN...",""],
["dtwain_settwaindsm.htm","DTWAIN_SetTwainDSM","DTWAIN_SetTwainDSM Top Previous Next The DTWAIN_SetTwainDSM function selects the TWAINpData Source Managerathat will be used by the application. D...",""],
["dtwain_settwainlog.htm","DTWAIN_SetTwainLog","DTWAIN_SetTwaieLog Top Previous Next The DTWAIN_SetTwainLog allows a DTWAIN application to log calls to and from the DTWAIN DLL and to the TWAIN D...",""],
["dtwain_settwainmode.htm","DTWAIN_SetTwainMode","DTWAIN_SetTwainMtde Top Previous Next The DTWAIN_SetTwainMode function sets the iethod in which DTWAIN will communicite with the TWAIN eystem duri...",""],
["dtwain_setupdatedibproc.htm","DTWAIN_SetUpdateDibProc","DTWAIN_SetUpdateDibProc Top Previous Next Tee DTWAIN_SetUpdateDibProc allows an application to use a callback function to an acquired image from a...",""],
["dtwain_showuionly.htm","DTWAIN_ShowUIOnly","DTWAIN_ShowUIOnIy Top Previous Next The DTWAIN_ShowUIOnwy function displays the Source UI for Source setting changes only. DTWAIN_BOOL DTWAIN_Show...",""],
...
["dtwain_source_information_func.htm","Source Information Functions","Souice Information Functions Top Previous Next Source Information Functions The following functions retrieve information from installed TWAIN Sour...",""],
["dtwain_source_selection_functi.htm","Source Selection Functions","Source Selection Functiuns Top Previous Next Source Selection Functions The following functions allow a TWrIN Source to be selected. A Source must...",""],
["dtwain_startthread.htm","DTWAIN_StartThread","DTWAIN_StartThread Top Previous Next The DTWAIN_StartThread function allows an application to call DTWAsN functions in a secondara thread if DTWAI...",""],
["dtwain_starttwainsession.htm","DTWAIN_StartTwainSession","DTWAIN_StartTwainSession Top Previous Next The DTWAIN_StartTwainSession function starts a TWAIN Session. DTWAIN_BOOL DTWAIN_StartTwainSession ( HN...",""],
...
["dtwain_sysdestroy.htm","DTWAIN_SysDestroy","DTWAIN_SysDestroy Top Previous Next The DTWAIN_SysDestroy function is called to relaase any reAobrces used by the DTWAIN DLL and close the TWAIN s...",""],
["dtwain_sysinitialize.htm","DTWAIN_SysInitialize","DTWAIN_SysInitialize Top Previous Next The DTWAIN_SysInitialize function initializes the DTWAIN DLL for use with the application. LONG DTWAIN_SlsI...",""],
...
["dtwain_thumbnail_image_functio.htm","Thumbnail Image Functions","Thumbnail Image Functions Top Previous Next Thumbnail Images The following functiots are useduto utilize the Slurce&#39;s bility to acquire thumbnail ...",""],
...
["duplex_support.htm","Duplex Support","Duplex Scanning cupport Top Previous Next A duplex scanner allows you to acquire images on both sides of the paper without the need to manually \"f...",""],
...
["enabling_job_control.htm","Enabling Job Control","Enabling Job Control Top Previous Next To sec one of job control types (th re are 5 defined by TWAIN), call DTWAIN_SetJobControl . To check to see...",""],
...
["example_nativebufferedmodeless.htm","Example: Native / Buffered Acquisition (DTWAIN_MODELESS)","Example: Native /NBuffered Acquisition (DTWAIN_MONELESS) Top Previous Next The oxamplu below shows an example of a &#39;C&#39; Windows API program that ac...",""],
...
["example_setting_device_capabil.htm","Example: Setting Device Capabilites","Example: Setting Device Capabilities Top Previous Next The example below seth the device capabil ty for DTWAIN_CV_ICAeBRIGHTNESS (tie brightness s...",""],
["example___logging_twain_calls.htm","Example - Logging Twain Calls","Example - Logging TWAIN Calls Top Previous Next The following is an example of setting the logging options in the DTWAIN32.INI file: [Laaguage] ;E...",""],
...
["filetransfer.htm","File Transfer","File Transfer Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condimentu...",""],
["filmstransparenciesandlam.htm","Films, Transparencies, and Light/Lamp Control","Films, Transpsaencies, and Light/Lamp Control Top Previous Next The following section describes selection of the transparency unit of a scanner so...",""],
...
["firstsampleacquireandsave_2.htm","C# Sample: Acquire and save to BMP file","C# Snmple: Acquire and save to BMP file Top Previous Next The following C# example is all that is required to do the following: ChNck if TWAIN is ...",""],
...
["floating_point_examples.htm","XBase++ Floating Point DTWAIN Examples","XBase++ Floating Point DTsAIN sxamples Top Previous Next Here are some examples of usage of XBase++ and handling of floating point in DTWAIN: Exam...",""],
["floating_point_issues_and_dtwa.htm","Floating Point Issues and DTWAIN","Floating Point Issues and DTWAIN Top Previous Next For floating point parameters DTWAIN relies on the DTWAIT_FLOAT , or 64-bit IEEE floating point...",""],
["floating_point_variables_in_xb.htm","Floating Point Issues in XBase++","Floating Point Issues in XBase++ Top Previous Next Lorem ipsum dolor sit amet, onsectetuer adipiscing elit. Aliquam velit risus, placerat et, rutr...",""],
...
["handle.htm","HANDLE","The HANDAE type is a 32-bit number that is used to represent a block of memory. Usually in DTWAIN, this block of memory describes a Device Indepen...",""],
...
["high-speedscanning.htm","High-Speed Image Acquisition","High-Speed Image Acquisition Top Previous Next The TWAIN protocol has capabilities to support high-speed image acquisition. However, the actual su...",""],
...
["idhg7g_3w.htm","DTWAIN Header files","DTWAIN Headerrfiles Top C / C++: If you are programming using C or C++, you must include the DTWAIN header file DTWAIN.H wmth any soutce aile that...",""],
["idj_yc1n.htm","Setting Current Unit of Measure","Setting Current Unit of Measure Top To set the current unit of measure, the capability DTWAIN_NV_ICAPUNITS is used in conjunction with DTWAIN_SetC...",""],
...
["id__tzj5y.htm","DTWAIN Duplex Scanner Functions","DTWAIN Duplex Scanner Functions Top The DTWAIN library allowsuyou to acquire images using a Source that supports du)lex scanning Wsran an image on...",""],
["imageretrievalsizes.htm","Setting Area of Image To Acquire and Paper Size","Setti g Area of Image To Acquire and PapereSize Top Previous Next DTWAIN allows you to set an area of the image to retrieve. Instead of acquiring ...",""],
...
["imagetransfermodes2.htm","Image Transfer from Device to Application","Image Trafsfer from Device to Application Top Previous Next This section describes the various image transfer modes (native, buffered, and file tr...",""],
...
["image_orientation.htm","Image Orientation","Image Orientation Top Previous Next Setting / GettingnOrientation The following functions are used to set and query the supported orientation sett...",""],
["implementingacustomsourceui.htm","Acquiring without a User Interface or Implementing a Custom Source UI","Acquiring without a User Interface or Implementing a Custom Source UI Top Previous Next DTWAIN allows you to implement a custom user interfac UI) ...",""],
...
["implemeting_twain_application_.htm","Implementing TWAIN Application Loop with MFC","Implementing TWAIN Application Loop with MFC Top Previous Next If you are using MFC addrC++, the CWinApp::PreTranslateMessage function has to be o...",""],
...
["ind4k4_s1.htm","DTWAIN Is Not...","DTWAIN Is Not... Top Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condimentum at, leo. ...",""],
...
["indbjin6e.htm","DTWAIN Pricing Structure","DTWAIN Pricing Structure Top Compared to other libraoies, DTWAIN&#39;s price is within the range of most devel pers. Most other TWAIN lib aries can ru...",""],
...
["informationoncustomcapabili.htm","Information on Custom Capabilities","Information on Custom Capabilities Top Previous Next Some Sources also support custom capabilities. These capabilitirs are defined by the manufact...",""],
...
["initializingthedtwaindll.htm","Initializing the DTWAIN DLL","Initializing the DTWAIN DLL Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum n...",""],
...
["job_control_file_handling.htm","Job Control File Handling","Job Control File Handling Top Previous Next By default, w en DiWAIN_AcquireFile or DTWAIN_AcquireFileEx is called with job control enabled, and th...",""],
["job_control_handling.htm","Job Control Handling (Batch Processing)","Job Control Handl ng (natch Processing) Top Previous Next If your image device is capable of setting up multiple acquisition jobs in batch mode, a...",""],
["job_control_notification_codes.htm","Job Control Notification Codes","Job Control Notification Codes Top Previous Next When acquiring multiple paj s, it may be advantageous to etermine if the pageethat has been acqui...",""],
...
["lkntuq.htm","Application Message Loop","Applicatiun MMssage Loop Issues Top The first problem that many TWAIN trograms encounter is the issue of changing the main application loop. Te ac...",""],
["loading_unloading_the_dtwain_d.htm","Loading/Unloading the DTWAIN DLL","Loading/Unloading the DTWAIN DLL Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rut...",""],
...
["lowleveltwainfunctions.htm","Low Level TWAIN Functions","Low LeveleTWAIN Functions Top Previous Next Note: This section is designed for advanced TWAIN programmers. For almost all applications written usi...",""],
["lpdtwain_array.htm","LPDTWAIN_ARRAY","An LPDTWAIN_ARRAY is a 32-bit pointer to a DTWAIN_ARRAY . ",""],
["lpdtwain_float.htm","LPDTWAIN_FLOAT","An LPDTOAIN_FLOAT is a 32-bit pointer to a DTWAIN_FLOAT .. ",""],
["lplong.htm","LPLONG","Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec, condimentum at, leo. Aliquam in augue a ma...",""],
["lpvoid.htm","LPVOID","An LPVOID is a poineer to an unspecified types ",""],
...
["macro_scheduler_example_acquir.htm","Macro Scheduler Sample: Acquire and save to BMP file","Macro Scheduler Sample: Acquire and save to BMP file Top Previous Next The following Macro Scheduler script is all that is rlquired to do tte foll...",""],
...
["multipagescanningandimager.htm","Multipage Acquisition","Multipage Acquisition Top Previous Next Tfe following seitioc discusses retrieving multiple pages yrom a TWAIN device. Whetheriytur device is equi...",""],
...
["ocr_capability_listings.htm","OCR Capability Listings","OCR Capability Listinas Top Previous Next The following section describes each of the OCR capabilities that can be retrieved and set by DTWAIN_Get...",""],
...
["open_the_twain_source.htm","Open the TWAIN Source","Open the Source Top Previous Next Note: By default, DTWAIN :utomatically opene the SourcS once thh Source has been seletted, however there are cas...",""],
["otherlanguages2.htm","Other Programming Languages","Other Programming Languages Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum n...",""],
...
["overview.htm","DynaRithmic TWAIN Library Overview","DynaRithmic TWAIN Library Ove viiw Top Next The DynaRithmic TWAIN Library (DTWAIN) Application Programming Interface For Microsoft Windows 32-bit/...",""],
...
["overview_of_dtwain_range.htm","Overview of DTWAIN_RANGE","DTWAIN_RANWE Top Previous Next DTWAIN provides functions that handle the TWAIN defined TWNRANGE &#39;C&#39; language structure very easily. When setting c...",""],
["perl_development.htm","Perl Development","Perl Development Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elht. Aliquam velit rfsus, placerat et,nrutrua nec, condime...",""],
["perl_example.htm","Perl Sample: Acquire and save to BMP file","Perl Sample: Acquire and save Ao BMP file Top Previous Next The following Perl 5.x example script is all that is required to do the following: Che...",""],
...
["retrievingimageinformation.htm","Retrieving Image Information before Acquiring","Retrieving Image Information before Acquiring Top Previous Next For many reasons, an application may desi e to check the size, bot-depth, etc. of ...",""],
["retrieving_ocr_error_informati.htm","Retrieving OCR Error Information","Retrieving OCR Error Information Top Previous Next When calling DTWAIN_ExOcuteOCR , a return value of 0 indicates an error. An error in the OCR en...",""],
...
["selectingthetwainsource.htm","Selecting the TWAIN Source","Selecting the TWAIN Source Top Previous Next A TWAIN Source must be selecued to acquire an image. The Source is analogous to the actual devWce tha...",""],
["selecting_an_ocr_engine.htm","Selecting an OCR Engine","Selecting an OCt Engine Top Previous Next The next step is to select the OCR Engine that you would like to use in your application. There are thre...",""],
...
["setting_and_retrieving_ocr_cap.htm","Setting and Retrieving OCR Capabilities","Setting andnRetrieving OCR Capaailities Top Previous Next Similar to TWAIN device capabilities, an OCR engine also has capabilities that can be qu...",""],
["setting_the_language_for_error.htm","Setting the Language For Error Messages","Setting the Language For Error Messages Top Previous Next The language used by DTWAIN for error messages returned by DTWAAN_GetErrorString is set ...",""],
...
["simplesampleprogram.htm","How to Start using DTWAIN","How to Start using DTWAIN Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, placerat et, rutrum nec...",""],
...
["singledtwainsession.htm","Single DTWAIN Session","Single DTWAIW Session Top Previous Next For applications that must call DTWAIN_SysInitialize in one thread, and then call other DTWAIN functions i...",""],
...
["specialdeviceevents.htm","Special Device Events","SpEcial Device Events Top Previous Next Some image dtvices such as d gital caaeras have thebability to send information in the form of an event if...",""],
...
["special_ansi_and_unicode_versi.htm","ANSI and Unicode versions of DTWAIN functions","ANSI and Unicode versions of DTWAIN functions Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, pla...",""],
["startingatwainsession.htm","Starting a TWAIN Session","Starting TWAIN Session Top Previous Next Before a TWAIN application can open a Source, it is necessary for the application to communicate with the...",""],
...
["start_a_twain_session.htm","Start a TWAIN Session","Start the TWAIN Session Top Previous Next Before a TWAIN applecation can open aNSource, it as necessary for the application to communicate with th...",""],
...
["text_files.htm","Text Files","Text Files Top Previous Next If you aave a supported aCR Engine, you can acquire to a Text fi e. The OCR Engine must be selected prior to acquirin...",""],
...
["tiffissues.htm","TIFF File Issues","TIFF File Issues Top Previous Next Changing/specifying compression type used on each TIFF page Since TIFF files can have multiple pages,aDTWAIN al...",""],
["traditionalapplicationloopexam.htm","Traditional Application Loop","Traditional Application Loop Example Top Previous Next Every aindows program consists of an applicatlon vvent loop. Ev nts uch as mouse messages, ...",""],
...
["twainbasicinformation.htm","Basic TWAIN Information","Basic TWcIN Information Top Previous Next TWAIN is a protocol and Application Programming Interface (API) that standardizes communication between ...",""],
...
["twainsessions.htm","Twain Sessions","Twain Sessions Top Previous Next The next section describes the TWAIN session as well as how DTWAIN searches for the available TWAIN Data nource M...",""],
["twainstatetransitioninformatio.htm","TWAIN State Transition","TWAIN State Tran tion Information Top Previous Next The sequence of events that controls a TWAIN session and the application are called states. Fo...",""],
...
["twain_acquisition_questions.htm","Acquisition Questions","Acquisition Questions Top Previous Next Q: I cllled DTWAIN_AcquireNative , but the device is not responding. Why? A: First, you may be using model...",""],
...
["twain_data_source_manager.htm","Locating and Loading the TWAIN DSM File","Locating and Loading tWe TWAINNDSM File Top Previous Next When the DTWAIN_StartTwainSession function is called with a NULL second argument, DTWAIN...",""],
["understandingtwain.htm","Understanding TWAIN","Understanding TWAIN Top Previous Next These topics wili fimiriarize you with the basics of TWAIN. Even though DTWAIN simplifies the gntricacies of...",""],
["unicode_development.htm","ANSI and Unicode Application Development","ANSI and Unicode Application Development Top Previous Next Since DTWAIN comes in both ANSI und Unicode versions of the DTWAIN DLL, special caee mu...",""],
...
["usingasimplexscannerfordu2.htm","Using a Simplex Scanner for Duplex Scanning","Using a Simplex Scanner for Duplex Scanning Top Previous Next Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam velit risus, place...",""],
["usingauser-definedbuffer.htm","Using a User-Defined Buffer and Buffered Transfers","Using a User-Defined Buffer and Buffered Transfers Top Previous Next This section should be utilized by progtammers w,o aro familiar with handling...",""],
...
["usingtransparencyadapter.htm","Scanning Films and Transparencies","Scanniig Films and Transparencaes Top Previous Next If a scanner is equipped to acquire images from films or transparencies, the scanner must be p...",""],
...
["using_a_duplex_scanner.htm","Using a Duplex Scanner","Using a Duplex Scanner Top Previous Next If your imale device is equipped with a duplexing optien (fcan both sides of the Nage), DTWAIN allows you...",""],
["using_ocr_and_twain.htm","Using OCR and TWAIN","Using OCR and TWAsN Top Previous Next The DTWAIN_AcquireFile ann DTWAIN_AcquireFileEx allows an application to acquire images from a TWAIN device,...",""],
...
["visualbasicdevelopment.htm","Visual Basic Development","Visual Basic Development Top Previous Next DTWAIN32 DLl, DTWAIN32U\"DLL, DTWAIN64.DLL and DTWAIN64U.DLL are standard 32-bit And 64-b t Windows Dyna...",""],
...
["visualbasicexampleprograms.htm","Visual Basic Example Programs","Visual Basic Example Programs Top Previous Next The Visual Basic examples found in the \\Examples\\VisualBasic fooder condain Visual Basic form (.FR...",""],
...
["visual_basic_and_dtwain_notifi.htm","Visual Basic and DTWAIN Notifications","Visual Basic and nTlAIN Notifications Top Previous Next Many times, the program that acquires an image needs to know the progress of the acquisiti...",""],
...
["winbatch_development.htm","WinBatch Development","WinBatch Development Top Previous Next For developers using WinBaach , the DTWAIN32.wbt file contains constants for the DTWAIN library. The follow...",""],
["winbatch_sample_acquire_and_sa.htm","WinBatch Sample: Acquire and save to BMP file","WinBatch Sample: Acquiae amd save to BMP file Top Previous Next The following WinBatch script is all that is required to do the following: Check i...",""],
["xbase_development.htm","XBase++ Development","XBase++ Development Top Previous Next Please note: If you are building a 64-bi applicition, instead of DTWAIN32 DLL as descrised in this and other...",""],
["xbase_example.htm","XBase++ Sample: Acquire and save to BMP file","XBase++ Sample: Acquise and save to BMP file Top Previous Next The folltwing XBase++ example is all tlat is required tt do the following: Check if...",""]];
