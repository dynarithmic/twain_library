...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_GetAcquireArea2StringA Lib "DTWAIN32.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByRef Unit As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetAcquireArea2String Lib "DTWAIN32.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByRef Unit As Integer) As Integer
    ...
    Declare Unicode Function DTWAIN_GetAcquireArea2StringW Lib "DTWAIN32.DLL" (ByVal Source As Integer, ByVal left As String, ByVal top As String, ByVal right As String, ByVal bottom As String, ByRef Unit As Integer) As Integer
